...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Dem_VAR)  ****************************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Dem_CONST)  **************************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_DEM_APPL)  ***********************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:Dem_CODE)  ***************************/
