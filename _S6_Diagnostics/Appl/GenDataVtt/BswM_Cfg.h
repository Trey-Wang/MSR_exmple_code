...
#define BswMConf_BswMRule_RuShutdownTimerStart (16) 
#define BswMConf_BswMRule_RuShutdownTimerExpired (15) 
...
/* -----------------------------------------------------------------------------
    &&&~ TIMER DEFINES
 ----------------------------------------------------------------------------- */
#define BSWM_TMR_ESH_NvM_WriteAllTimer       2U 
#define BSWM_TMR_ESH_NvM_CancelWriteAllTimer 1U 
#define BSWM_TMR_BswMrpShutdownTimer         0U 
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_AlShutdownTimerStart[1];
  BswM_ActionListQueueType AL_AlShutdownTimerStop[1];
  BswM_ActionListQueueType AL_AlShutdownTimerExpired[1];
...
{
  BswM_TimerStateType MRP_BswMrpShutdownTimer[1];
...
{
  BswM_TimerValueType MRP_BswMrpShutdownTimer[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[23];
