...
#define PDUR_FCT_CANTPCPYTX 0x07U 
 /*   PduR_ComTransmit  PduR_CanIfIfRxIndication  PduR_CanIfTransmit  PduR_CanIfTxConfirmation  PduR_DcmTransmit  PduR_CanTpTpRxIndication  PduR_CanTpTransmit  PduR_CanTpTxConfirmation  PduR_CanTpStartOfReception  PduR_CanTpCopyRxData  PduR_CanTpCopyTxData  */ 
...
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_Receive_0fb271d2          0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_Receive_0fb271d2           0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_Transmit_0fb271d2          0
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_Response_MyECU_0fb271d2 1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_Transmit_0fb271d2         0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_RequestGlobal_0fb271d2 1
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Request_MyECU_0fb271d2 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_RequestGlobal_0fb271d2 0
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_Request_MyECU_0fb271d2 1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_0fb271d2 0
/**\} */
