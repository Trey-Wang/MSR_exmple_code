...
#define DEM_CFG_EQ2_EVENTCOUNTOFSATELLITEINFO                         13U
#define DEM_CFG_EQ2_EVENTTABLEINDENDIDXOFSATELLITEINFO                13U
...
#define DemConf_DemEventParameter_AutoCreatedDemEvent_EcuMConfiguration_ECUM_E_ALL_RUN_REQUESTS_KILLED          8U 
#define DemConf_DemEventParameter_AutoCreatedDemEvent_EcuMConfiguration_ECUM_E_CONFIGURATION_DATA_INCONSISTENT  9U 
#define DemConf_DemEventParameter_AutoCreatedDemEvent_EcuMConfiguration_ECUM_E_IMPROPER_CALLER                  10U 
#define DemConf_DemEventParameter_AutoCreatedDemEvent_EcuMConfiguration_ECUM_E_RAM_CHECK_FAILED                 11U 
...
#define DemConf_DemEventParameter_DTC_0x000002                                                                  12U 
...
#define DEM_CFG_GLOBAL_PRIMARY_LAST                                   12U          /* Highest EventID with DemEventDestination==DEM_DTC_ORIGIN_PRIMARY_MEMORY, or 0 if no such destination is configured. */ 
...
#define DEM_CFG_STATUS_DATABLOCK_SIZE                                 22U          /* Size of the NvM block (NvM/NvMBlockDescriptor/NvMNvBlockLength) that's referenced via DemNvRamBlockId/DemNvRamBlockIdRef and has DemNvRamBlockId/DemNvRamBlockIdType=DEM_NVBLOCK_STATUS */ 
...
#define DEM_CFG_GLOBAL_CLEAR_DTC_RUNTIME_LIMIT                        13U                               /* not configured, here substituted by number of events (incl. event #0) */ 
...
#define DEM_CFG_GLOBAL_STATUS_MASK                                    0x79U                             /* /Dem/DemGeneral/DemDtcStatusAvailabilityMask */ 
...
#define Dem_Cfg_GetConfigurationIdOfPCConfig()                        0x8BB5U  /**< Magic constant derived from the configuration parameters /Dem/DemGeneral/DemCompiledConfigId and /Dem/DemGeneral/DemCompiledPostbuildCrc. Each value change is evidence to incompatible NV stored data and triggers a re-initialization of the NV data. */
...
#define Dem_Cfg_GetSizeOfEventTableOfPCConfig()                       13U  /**< the number of accomplishable value elements in Dem_Cfg_EventTable */
...
#define Dem_Cfg_GetSizeOfMemoryCommitNumberOfPCConfig()               10U  /**< the number of accomplishable value elements in Dem_Cfg_MemoryCommitNumber */
...
#define Dem_Cfg_IsJumpDownOfDebounceTable(Index)                      (((boolean)(Dem_Cfg_GetMaskedBitsOfDebounceTable(Index) == 0x06U)) != FALSE)  /**< DemDebounceCounterJumpDown of the DemEventParameter/DemEventClass/DemDebounceAlgorithmClass/DemDebounceCounterBase */
...
#define Dem_Cfg_IsJumpUpOfDebounceTable(Index)                        (((boolean)(Dem_Cfg_GetDecrementStepSizeOfDebounceTable(Index) == -1)) != FALSE)  /**< DemDebounceCounterJumpUp of the DemEventParameter/DemEventClass/DemDebounceAlgorithmClass/DemDebounceCounterBased */
...
#define Dem_Cfg_GetDtcTableIdxOfEventTable(Index)                     Dem_Cfg_GetEventKindOfEventTable(Index)  /**< the index of the 1:1 relation pointing to Dem_Cfg_DtcTable */
...
#define Dem_Cfg_GetExtendedDataTableIdxOfEventTable(Index)            Dem_Cfg_GetEventKindOfEventTable(Index)  /**< the index of the 1:1 relation pointing to Dem_Cfg_ExtendedDataTable */
...
#define Dem_Cfg_GetEventCountOfSatelliteInfo(Index)                   13U  /**< Satellite individual size of the monitor/event data RAM buffer */
#define Dem_Cfg_GetEventTableIndEndIdxOfSatelliteInfo(Index)          13U  /**< the end index of the 0:n relation pointing to Dem_Cfg_EventTableInd */
...
typedef struct Dem_Cfg_SatelliteInfoType0_s {
  volatile Dem_SatelliteData_DataType SatelliteData[ 13 ];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Dem_Cfg_EventTableType, DEM_CONST) Dem_Cfg_EventTable[13];
#define DEM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Dem_SharedDataPtrType, DEM_CONST) Dem_Cfg_MemoryEntry[9];
#define DEM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern volatile VAR(Dem_Cfg_EventDebounceValueType, DEM_VAR_NOINIT) Dem_Cfg_EventDebounceValue[13];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern volatile VAR(Dem_Event_InternalStatusType, DEM_VAR_NOINIT) Dem_Cfg_EventInternalStatus[13];
#define DEM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern volatile VAR(Dem_Cfg_MemoryCommitNumberType, DEM_VAR_NOINIT) Dem_Cfg_MemoryCommitNumber[10];
#define DEM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
