...
#define ComConf_ComSignal_sig_State_RearLeftDoor_2b456e3f             0
#define ComConf_ComSignal_sig_State_RearRightDoor_2b456e3f            1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_sig_RearInteriorLight_0723e95e              0
/**\} */
...
#define Com_GetBitLengthOfRxAccessInfo(Index)                         ((Com_BitLengthOfRxAccessInfoType)((Com_GetBusAccOfRxAccessInfo(Index) + 0x01U)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBytePositionOfRxAccessInfo(Index)                      Com_GetBusAccOfRxAccessInfo(Index)  /**< Little endian byte position of the signal or group signal within the I-PDU. */
#define Com_GetInitValueIdxOfRxAccessInfo(Index)                      Com_GetBusAccOfRxAccessInfo(Index)  /**< the index of the 0:1 relation pointing to Com_ConstValueUInt8,Com_ConstValueUInt16,Com_ConstValueUInt32,Com_ConstValueUInt64,Com_ConstValueSInt8,Com_ConstValueSInt16,Com_ConstValueSInt32,Com_ConstValueSInt64 */
#define Com_GetRxDataTimeoutSubstitutionValueIdxOfRxAccessInfo(Index) Com_GetBusAccOfRxAccessInfo(Index)  /**< the index of the 0:1 relation pointing to Com_ConstValueUInt8,Com_ConstValueUInt16,Com_ConstValueUInt32,Com_ConstValueUInt64,Com_ConstValueSInt8,Com_ConstValueSInt16,Com_ConstValueSInt32,Com_ConstValueSInt64 */
...
#define Com_GetRxPduInfoIdxOfRxAccessInfo(Index)                      Com_GetBusAccOfRxAccessInfo(Index)  /**< the index of the 1:1 relation pointing to Com_RxPduInfo */
#define Com_GetStartByteInPduPositionOfRxAccessInfo(Index)            Com_GetBusAccOfRxAccessInfo(Index)  /**< Start Byte position of the signal or group signal within the I-PDU. */
...
#define Com_GetPduGrpVectorEndIdxOfRxPduGrpInfo(Index)                ((Com_PduGrpVectorEndIdxOfRxPduGrpInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfRxPduGrpInfo(Index)              ((Com_PduGrpVectorStartIdxOfRxPduGrpInfoType)((Index)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(Index)                ((Com_RxAccessInfoIndEndIdxOfRxPduInfoType)(((Index) + 2U)))  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoInd */
...
#define Com_GetRxDefPduBufferEndIdxOfRxPduInfo(Index)                 ((Com_RxDefPduBufferEndIdxOfRxPduInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_RxDefPduBuffer */
#define Com_GetRxDefPduBufferLengthOfRxPduInfo(Index)                 ((Com_RxDefPduBufferLengthOfRxPduInfoType)(((Index) + 1U)))  /**< the number of relations pointing to Com_RxDefPduBuffer */
...
#define Com_GetRxSigInfoEndIdxOfRxPduInfo(Index)                      ((Com_RxSigInfoEndIdxOfRxPduInfoType)(((Index) + 2U)))  /**< the end index of the 0:n relation pointing to Com_RxSigInfo */
...
#define Com_GetTimePeriodOfTxModeFalse(Index)                         ((Com_TimePeriodOfTxModeFalseType)(((Index) + 1U)))  /**< Cycle time factor. */
...
#define Com_GetTimePeriodOfTxModeTrue(Index)                          ((Com_TimePeriodOfTxModeTrueType)(((Index) + 1U)))  /**< Cycle time factor. */
#define Com_GetPduGrpVectorEndIdxOfTxPduGrpInfo(Index)                ((Com_PduGrpVectorEndIdxOfTxPduGrpInfoType)(((Index) + 2U)))  /**< the end index of the 0:n relation pointing to Com_PduGrpVector */
#define Com_GetPduGrpVectorStartIdxOfTxPduGrpInfo(Index)              ((Com_PduGrpVectorStartIdxOfTxPduGrpInfoType)(((Index) + 1U)))  /**< the start index of the 0:n relation pointing to Com_PduGrpVector */
...
#define Com_GetPduWithMetaDataLengthOfTxPduInfo(Index)                ((Com_PduWithMetaDataLengthOfTxPduInfoType)(((Index) + 1U)))  /**< Length of Pdu with MetaData. */
#define Com_GetTxBufferEndIdxOfTxPduInfo(Index)                       ((Com_TxBufferEndIdxOfTxPduInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferLengthOfTxPduInfo(Index)                       ((Com_TxBufferLengthOfTxPduInfoType)(((Index) + 1U)))  /**< the number of relations pointing to Com_TxBuffer */
...
#define Com_GetTxPduInitValueEndIdxOfTxPduInfo(Index)                 ((Com_TxPduInitValueEndIdxOfTxPduInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_TxPduInitValue */
...
#define Com_GetBitLengthOfTxSigInfo(Index)                            ((Com_BitLengthOfTxSigInfoType)(((Index) + 1U)))  /**< Bit length of the signal or group signal. */
...
#define Com_GetBusAccOfTxSigInfo(Index)                               ((Com_BusAccOfTxSigInfoType)((Index)))  /**< BUS access algorithm for signal or group signal packing / un-packing. */
#define Com_GetByteLengthOfTxSigInfo(Index)                           ((Com_ByteLengthOfTxSigInfoType)((Index)))  /**< Byte length of the signal or group signal. */
...
#define Com_GetTxBufferEndIdxOfTxSigInfo(Index)                       ((Com_TxBufferEndIdxOfTxSigInfoType)(((Index) + 1U)))  /**< the end index of the 0:n relation pointing to Com_TxBuffer */
#define Com_GetTxBufferLengthOfTxSigInfo(Index)                       ((Com_TxBufferLengthOfTxSigInfoType)(((Index) + 1U)))  /**< the number of relations pointing to Com_TxBuffer */
...
{
  Com_HandleRxPduDeferredType msg_Receive_oCAN00_3abd61be[1];
...
{
  Com_RxDefPduBufferType msg_Receive_oCAN00_3abd61be[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_CycleTimeCntType, COM_VAR_NOINIT) Com_CycleTimeCnt[1];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_CyclicSendRequestType, COM_VAR_NOINIT) Com_CyclicSendRequest[1];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_DelayTimeCntType, COM_VAR_NOINIT) Com_DelayTimeCnt[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RepCntType, COM_VAR_NOINIT) Com_RepCnt[1];
#define COM_STOP_SEC_VAR_NOINIT_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RepCycleCntType, COM_VAR_NOINIT) Com_RepCycleCnt[1];
#define COM_STOP_SEC_VAR_NOINIT_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(Com_RxSigBufferUInt8Type, COM_VAR_NOINIT) Com_RxSigBufferUInt8[2];
#define COM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
