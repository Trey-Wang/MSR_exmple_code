...
#define PduR_GetSizeOfTxIf2UpOfPCConfig()                             1UL  /**< the number of accomplishable value elements in PduR_TxIf2Up */
...
#define PduR_GetTransmitFctPtrIdxOfTx2Lo(Index)                       ((PduR_TransmitFctPtrIdxOfTx2LoType)((Index)))  /**< the index of the 1:1 relation pointing to PduR_TransmitFctPtr */
