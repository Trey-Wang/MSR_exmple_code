...
#define DioConf_DioChannel_env_InteriorLightFront    ((Dio_ChannelType) 0) 
...
#define DioConf_DioChannel_env_InteriorLightFrontDEFECT    ((Dio_ChannelType) 3) 
#define DioConf_DioChannel_env_DisplayBusAwake    ((Dio_ChannelType) 4) 
