...
#define NVM_TOTAL_NUM_OF_NVRAM_BLOCKS         (14UL)

/* internal buffer size */
#define NVM_INTERNAL_BUFFER_LENGTH            24UL
...
#define NvMConf_NvMBlockDescriptor_CpApMySwcSnNvMPimLightOnOffCounter (3UL) 
#define NvMConf_NvMBlockDescriptor_CpApMySwcSnNvMPimOdometer (4UL) 
#define NvMConf_NvMBlockDescriptor_DemStatusDataBlock (5UL) 
...
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock4 (10UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock5 (11UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock6 (12UL) 
#define NvMConf_NvMBlockDescriptor_DemPrimaryDataBlock7 (13UL) 
