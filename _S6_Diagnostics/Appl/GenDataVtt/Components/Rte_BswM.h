...
#  define Rte_InitValue_Provide_MrpPShutdownTimerDisplay_requestedMode (1U)
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_BswM_Provide_MrpPShutdownTimerDisplay_requestedMode(BswM_MdgShutdownTimerState data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
 ...
 *********************************************************************************************************************/
#  define Rte_Write_Provide_MrpPShutdownTimerDisplay_requestedMode Rte_Write_BswM_Provide_MrpPShutdownTimerDisplay_requestedMode
