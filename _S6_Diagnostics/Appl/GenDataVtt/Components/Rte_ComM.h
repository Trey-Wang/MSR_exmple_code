 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Switch_ComM_UM_USR_INTERIOR_LIGHT_currentMode(ComM_ModeType nextMode); /* PRQA S 0850 */ /* MD_MSR_19.8 */
 ...
 * Rte_Switch_<p>_<m>
 *********************************************************************************************************************/
#  define Rte_Switch_UM_USR_INTERIOR_LIGHT_currentMode Rte_Switch_ComM_UM_USR_INTERIOR_LIGHT_currentMode
