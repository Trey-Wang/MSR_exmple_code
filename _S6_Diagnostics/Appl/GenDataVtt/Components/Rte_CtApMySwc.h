...
extern VAR(BswM_ESH_RunRequest, RTE_VAR_NOINIT) Rte_CpApMySwc_PpBswMPostRunRequestCtApMySwc_requestedMode; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(BswM_ESH_RunRequest, RTE_VAR_NOINIT) Rte_CpApMySwc_PpBswMRunRequestCtApMySwc_requestedMode; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern VAR(BswM_MdgShutdownTimerState, RTE_VAR_NOINIT) Rte_BswM_Provide_MrpPShutdownTimerDisplay_requestedMode; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(IdtDoorState, RTE_VAR_NOINIT) Rte_CpSaDoorFrontLeft_PpDoorState_DeDoorState; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern VAR(uint16, RTE_VAR_NOINIT) Rte_Irv_CpApMySwc_IrvDoorStateOld; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_IRead_RCtApMySwcCode_PpDoorStateFrontLeft_DeDoorState() \
  (Rte_CpSaDoorFrontLeft_PpDoorState_DeDoorState)
/* PRQA L:L1 */
...
#  define Rte_Read_CtApMySwc_PpDoorStateRearRight_DeDoorState(data) ((void)Com_ReceiveSignal(ComConf_ComSignal_sig_State_RearRightDoor_2b456e3f, (data)), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_CtApMySwc_PpMrpPShutdownTimerDisplayCtApMySwc_requestedMode(data) (*(data) = Rte_BswM_Provide_MrpPShutdownTimerDisplay_requestedMode, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_CtApMySwc_PpBswMPostRunRequestCtApMySwc_requestedMode(data) (Rte_CpApMySwc_PpBswMPostRunRequestCtApMySwc_requestedMode = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Write_PpBswMRunRequestCtApMySwc_requestedMode Rte_Write_CtApMySwc_PpBswMRunRequestCtApMySwc_requestedMode
#  define Rte_Write_CtApMySwc_PpBswMRunRequestCtApMySwc_requestedMode(data) (Rte_CpApMySwc_PpBswMRunRequestCtApMySwc_requestedMode = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_OpCycle_IgnitionCycle_SetOperationCycleState(arg1) (Dem_SetOperationCycleState((Dem_OperationCycleIdType)1, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Call_PpNvMLightOnOffCtApMySwc_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)3, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define RTE_START_SEC_NVM_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
...
#  define Rte_Call_PpNvMOdometerCtApMySwc_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)4, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Call_PpNvMOdometerCtApMySwc_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)4, arg1)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_ExArLightOnOffCounter() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */

#  define Rte_Exit_ExArLightOnOffCounter() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */

#  define Rte_Enter_ExArOdometer() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */

#  define Rte_Exit_ExArOdometer() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */
...
FUNC(void, CtApMySwc_CODE) RCtApMySwcInit(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, CtApMySwc_CODE) RCtApMySwcPostRunCode(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
