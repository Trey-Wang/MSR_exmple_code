 ...
 *
 *   Description:  Application types header file for SW-C <CtSaDisplay>
 *********************************************************************************************************************/
...
#  ifndef CMIGNITION_STATEON
#   define CMIGNITION_STATEON (0U)
#  endif

#  ifndef CMIGNITION_STATEOFF
#   define CMIGNITION_STATEOFF (1U)
#  endif
