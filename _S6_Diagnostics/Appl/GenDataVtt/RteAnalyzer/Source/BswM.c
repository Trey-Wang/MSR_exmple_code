 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_Provide_MrpPShutdownTimerDisplay_requestedMode(BswM_MdgShutdownTimerState data)
 *
 * Mode Interfaces:
 * ================
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/
  ...
  {
    FncPtrType BswM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    BswM_FctPtr = (FncPtrType)Rte_Write_Provide_MrpPShutdownTimerDisplay_requestedMode; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_BswM_Rte_Write_Provide_MrpPShutdownTimerDisplay_requestedMode(Rte_InitValue_Provide_MrpPShutdownTimerDisplay_requestedMode);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void BswM_TestDefines(void)
{
  ...
  BswM_MdgShutdownTimerState Test_MdgShutdownTimerState_MV_1 = RTE_MODE_MdgShutdownTimerState_TIMER_EXPIRED;
  BswM_MdgShutdownTimerState Test_MdgShutdownTimerState_MV_2 = RTE_MODE_MdgShutdownTimerState_TIMER_NOT_EXPIRED;
  BswM_MdgShutdownTimerState Test_MdgShutdownTimerState_TV = RTE_TRANSITION_MdgShutdownTimerState;
}
