 ...
 *   EcuMConf_EcuMSleepMode_EcuMSleepMode (0U)
 ...
 *   EcuMConf_EcuMFlexUserConfig_EcuMFlexUserConfig (0U)
 *
 *********************************************************************************************************************/
...
static void EcuM_TestDefines(void)
{
  ...
  EcuM_ModeType Test_EcuM_ModeType_V_1 = EcuMConf_EcuMResetMode_ECUM_RESET_WDG;
  EcuM_ModeType Test_EcuM_ModeType_V_2 = EcuMConf_EcuMResetMode_ECUM_RESET_IO;
  EcuM_ModeType Test_EcuM_ModeType_V_3 = EcuMConf_EcuMResetMode_ECUM_RESET_MCU;
  EcuM_ModeType Test_EcuM_ModeType_V_4 = EcuMConf_EcuMResetMode_ECUM_RESET_WAKEUP;
  EcuM_ModeType Test_EcuM_ModeType_V_5 = EcuMConf_EcuMSleepMode_EcuMSleepMode;
  ...
  EcuM_UserType Test_EcuM_UserType_V_1 = EcuMConf_EcuMFlexUserConfig_EcuMFlexUserConfig;
}
