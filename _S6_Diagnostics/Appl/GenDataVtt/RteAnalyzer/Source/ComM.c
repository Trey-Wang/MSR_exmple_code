 ...
 * Mode Interfaces:
 * ================
 *   Std_ReturnType Rte_Switch_UM_USR_INTERIOR_LIGHT_currentMode(ComM_ModeType mode)
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/
  ...
  {
    FncPtrType ComM_FctPtr; /* PRQA S 3408 */ /* MD_Rte_TestCode */
    ComM_FctPtr = (FncPtrType)Rte_Switch_UM_USR_INTERIOR_LIGHT_currentMode; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_ComM_Rte_Switch_UM_USR_INTERIOR_LIGHT_currentMode(RTE_MODE_ComMMode_COMM_NO_COMMUNICATION);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   - triggered by server invocation for OperationPrototype <GetCurrentComMode> of PortPrototype <UR_USR_INTERIOR_LIGHT>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <GetMaxComMode> of PortPrototype <UR_USR_INTERIOR_LIGHT>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <GetRequestedComMode> of PortPrototype <UR_USR_INTERIOR_LIGHT>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 ...
 *   - triggered by server invocation for OperationPrototype <RequestComMode> of PortPrototype <UR_USR_INTERIOR_LIGHT>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
