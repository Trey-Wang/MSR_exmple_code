 ...
 *
 *   Description:  C-Code implementation template for BSW Module <CanNm>
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Schedulable Entity Name: CanNm_MainFunction
 *
 *********************************************************************************************************************/

FUNC(void, CANNM_CODE) CanNm_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: CanNm_MainFunction
 *********************************************************************************************************************/

  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_0();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_0();
  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_1();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_1();
  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_2();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_2();
  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_3();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_3();
  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_4();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_4();
  TSC_CanNm_SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_5();
  TSC_CanNm_SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_5();
