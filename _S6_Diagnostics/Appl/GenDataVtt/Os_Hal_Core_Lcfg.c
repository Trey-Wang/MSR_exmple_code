...
/*! HAL dynamic core to thread data: OsCore */
OS_LOCAL VAR(Os_Hal_Core2ThreadType, OS_VAR_NOINIT_FAST) OsCfg_Hal_Core2Thread_OsCore_Dyn;
...
{
  /* No core exclusive interrupt sources to be initialized by OsCore. */
  NULL_PTR
};


/*! HAL core configuration data: OsCore */
CONST(Os_Hal_CoreConfigType, OS_CONST) OsCfg_Hal_Core_OsCore =
{
  /* .Name  =           */ "OsCore",
  /* .CANoeEmuCoreId  = */ 0
};
...
CONST(Os_Hal_CoreAsrConfigType, OS_CONST) OsCfg_Hal_CoreAsr_OsCore =
{
  /* .HalConfig =              */ &OsCfg_Hal_Core_OsCore,
  /* .NumberOfCANoeEmuTasks  = */ 14,
  /* .ContextInitList =        */ OsCfg_Hal_ContextInitList_OsCore
};
...
CONST(Os_Hal_Core2ThreadConfigType, OS_CONST) OsCfg_Hal_Core2Thread =
{
  /* .Core2Thread = */
  {
    &OsCfg_Hal_Core2Thread_OsCore_Dyn, /* OS_CORE_ID_0 */
  }
};
  ...
  OsCfg_Hal_System_InterruptSourceRefs[OS_CFG_NUM_SYSTEM_INTERRUPTSOURCEREFS + 1] =
{
  ...
  &OsCfg_Hal_IntIsr_VttSysVarIsr_0,
  &OsCfg_Hal_IntIsr_CanIsrRx_0,
  &OsCfg_Hal_IntIsr_CanIsrTx_0,
  &OsCfg_Hal_IntIsr_CanIsrWakeup_0,
