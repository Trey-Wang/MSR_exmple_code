...
{
  /* .Name  =       */ "CanIsrWakeup_0",
  /* .Source =      */ OS_IRQ_CanIsrWakeup_0,
  /* .Level =       */ 1,
  /* .Handler =     */ &Os_Hal_CanoeIrqHandler_CanIsrWakeup_0,
  /* .RoutingMask = */ (1<<0)
};
...
CONST(Os_Hal_IntIsrConfigType, OS_CONST) OsCfg_Hal_IntIsr_VttSysVarIsr_0 =
{
  /* .Name  =       */ "VttSysVarIsr_0",
  /* .Source =      */ OS_IRQ_VttSysVarIsr_0,
  /* .Level =       */ 2,
  /* .Handler =     */ &Os_Hal_CanoeIrqHandler_VttSysVarIsr_0,
  /* .RoutingMask = */ (1<<0)
};
