...
#define ECUM_ISDEF_REASONOFWAKEUPSOURCELIST                           STD_ON
...
#define ECUM_EQ2_MCUMODEOFSLEEPMODELIST                               McuConf_McuModeSettingConf_SLEEP
#define ECUM_EQ2_WAKEUPSOURCEOFSLEEPMODELIST                          31UL
#define ECUM_EQ2_CHANNELOFWAKEUPSOURCELIST                            
#define ECUM_EQ2_REASONOFWAKEUPSOURCELIST                             McuConf_McuResetReasonConf_McuResetReasonConf
