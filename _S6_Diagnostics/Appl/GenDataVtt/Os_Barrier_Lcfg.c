...
/*! Dynamic barrier of core: OsCore */
OS_LOCAL VAR(volatile Os_BarrierBaseType, OS_VAR_NOINIT) OsCfg_Barrier_OsCore_Dyn;
...
/*! Barrier configuration data: OsCore */
CONST(Os_BarrierBaseConfigType, OS_CONST) OsCfg_Barrier_OsCore =
{
  /* .Dyn           = */ &OsCfg_Barrier_OsCore_Dyn,
