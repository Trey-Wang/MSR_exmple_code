...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:output method="xml" version="1.0" encoding="ISO-8859-1" standalone="no" doctype-system="..\DTD7.2\DVW.DTD"/>
...
<!-- DVW element rule -->
  <!-- Set DTD version to 7.2, no external conversion required  -->
  <!-- Remove CompatibleVersions because DTD 7.2 is incompatible -->

    <xsl:template match="DVW">
        <xsl:attribute name="DTDVersion">7.2</xsl:attribute>
