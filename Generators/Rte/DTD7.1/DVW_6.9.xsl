...
<!-- DVW element rule -->
  <!-- Set DTD version to 7.1, no external conversion required  -->
  <!-- Remove CompatibleVersions because DTD 7.1 in incompatible -->

    <xsl:template match="DVW">
        <xsl:attribute name="DTDVersion">7.1</xsl:attribute>
