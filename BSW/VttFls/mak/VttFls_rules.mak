...
# --------     ---------------------     -------------------------------------#
# Chl          Christian Leder           Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2014/02/07   1.00.00  Chl  Initial Version                                  #
# 2015/03/09   1.00.01  Chl  First official version                           #
# 2015/08/12   1.01.00  Chl  VttCntrl file added                              #
# 2016/06/17   2.00.00  Bmz  added VttFls_rules_17_Pmu.mak file               #
# 2016/07/28   2.00.01  Bmz  modified the property target name in ALM         #
# 2016/08/19   2.01.00  Bmz  added access via wildcard, FEAT1842              #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Fls
Fls_FILES                = VttFls\Fls.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       +=  VttFls\Fls.c VttCntrl\VttCntrl_Fls.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  +=  $(wildcard $(GENDATA_DIR)/Fls_*.c) $(GENDATA_DIR)\VttCntrl_Fls_Cfg.c
