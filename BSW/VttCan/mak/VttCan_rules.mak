...
# ----------   -------  ---- -------------------------------------------------#
# 2015/03/12   1.00     Bir  derived from DrvCan_CoreAsr Used for Vtt module  #
# 2015/04/28   1.00.01  Bir  ESCAN00082576 adapt Vtt path
# 2015/12/02   2.00.00  Bir  Change VttCntrl_Can sources (add VttCntrl_Can_Cfg.c and move VttCntrl_Can.c to static part)
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Can
Can_FILES               = VttCan\Can.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttCan\Can.c VttCan\Can_Irq.c VttCntrl\VttCntrl_Can.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Can_PBcfg.c $(GENDATA_DIR)\Can_Lcfg.c $(GENDATA_DIR)\VttCntrl_Can_Cfg.c
