...
# define NM_ASR4NMCAN_VERSION                          (0x0603U)
# define NM_ASR4NMCAN_RELEASE_VERSION                  (0x00U)
 ...
 *  \pre         -
 *  \note        Called from NM Interface
 *  \config      CANNM_NODE_ID_ENABLED = STD_ON
 *  \context     TASK|ISR1|ISR2
 *  \reentrant   TRUE
 *  \synchronous TRUE
 ...
 *  \pre         -
 *  \note        Called from NM Interface
 *  \config      CANNM_NODE_DETECTION_ENABLED = STD_ON or CANNM_USER_DATA_ENABLED = STD_ON or CANNM_NODE_ID_ENABLED = STD_ON
 *  \context     TASK|ISR1|ISR2
 *  \reentrant   TRUE
 *  \synchronous FALSE
 ...
 *  \pre         -
 *  \note        Called from NM Interface
 *  \config      CANNM_COM_CONTROL_ENABLED = STD_ON
 *  \context     TASK|ISR1|ISR2
 *  \reentrant   TRUE
 *  \synchronous FALSE
 ...
 * \exclude CanNm_MainFunction, CanNm_RequestBusSynchronization, CanNm_SetSleepReadyBit
 ...
 * \exclude CanNm_MainFunction, CanNm_RequestBusSynchronization, CanNm_SetUserData
 * \protects CanNm_TxMessageData (write)
 * \endexclusivearea
 *
 ...
 * \exclude CanNm_MainFunction, CanNm_GetUserData, CanNm_GetNodeIdentifier, CanNm_GetPduData
