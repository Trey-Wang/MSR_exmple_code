...
#if (  (CANNM_SW_MAJOR_VERSION != (0x06U)) \
    || (CANNM_SW_MINOR_VERSION != (0x03U)) \
    || (CANNM_SW_PATCH_VERSION != (0x00U)) )
# error "Vendor specific version numbers of CanNm.c and CanNm.h are inconsistent"
#endif

/* vendor specific version information check */
#if (  (CANNM_CBK_MAJOR_VERSION != (0x06U)) \
    || (CANNM_CBK_MINOR_VERSION != (0x03U)) \
...
# define CANNM_CHANNEL_TYPE_ONLY                    void /* PRQA S 3460 */ /* MD_MSR_19.4 */
...
# define CanNm_Rtm_Start(measurement) { \
                                      ...
                                      } /* PRQA S 0342,3109,3458 */ /* MD_CanNm_0342,MD_MSR_14.3,MD_MSR_19.4 */
...
CANNM_LOCAL VAR( uint8, CANNM_VAR_NOINIT ) nmMinPnChannel;
...
CANNM_LOCAL P2CONST( CanNm_ConfigType, CANNM_VAR_ZERO_INIT, CANNM_INIT_DATA ) CanNm_ConfigPtr = NULL_PTR;
#endif
...
# if defined ( CANNM_CANIF_RANGE_CONFIG_DLC_CHECK )
  ...
  adjustedInfoLength = CanNm_GetSizeOfPnFilterMask();
  CANNM_DUMMY_STATEMENT(PduInfoPtr); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
# else
...
# endif
  ) /* COV_CANNM_PN_ENABLED */
  {
    ...
    for( pnClusterRequestByte = 0U; pnClusterRequestByte < CanNm_GetSizeOfPnFilterMask(); pnClusterRequestByte++ )
    {
      ...
      {
        SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_0(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
        ...
        SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_0(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8        pnClusterRequestByte;
  uint8        pnClusterRequestBit;
  uint8        pnClusterRequestNew = 0U;
  boolean      pnClusterRequestChanged;
  PduInfoType  nmPnInfo;
...
#  if ( CANNM_PN_ERA_CALC_FEATURE_ENABLED == STD_ON )
            ...
            { /* PRQA S 0715 */ /* MD_MSR_1.1 */ /* ESCAN00064309 */
...
CANNM_LOCAL_INLINE FUNC( void, CANNM_CODE ) CanNm_CopyRxMessageData( CANNM_CHANNEL_TYPE_FIRST P2CONST( PduInfoType, AUTOMATIC, CANNM_APPL_VAR ) PduInfoPtr )
{
  ...
  SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_4(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
# endif
  ...
  SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_4(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
}
#endif
...
# endif
    ...
    {
      CanNm_SetTimeoutTimer(CANNM_CHANNEL_IDX, (CanNm_TimeoutTimerType)(CanNm_GetTimeoutTimeOfChannelConfig(CANNM_CHANNEL_IDX) + 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
# if ( CANNM_REMOTE_SLEEP_IND_ENABLED == STD_ON )
      if( CanNm_GetNmState(CANNM_CHANNEL_IDX) == NM_STATE_NORMAL_OPERATION )
      {
        CanNm_SetRemoteSleepTimer(CANNM_CHANNEL_IDX, (CanNm_RemoteSleepTimerType)(CanNm_GetRemoteSleepIndTimeOfChannelConfig(CANNM_CHANNEL_IDX) + 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
      }
# endif
      if( ( CanNm_GetNmState(CANNM_CHANNEL_IDX) == NM_STATE_NORMAL_OPERATION ) ||
          ( CanNm_GetNmState(CANNM_CHANNEL_IDX) == NM_STATE_REPEAT_MESSAGE ) )
      {
        CanNm_SetMsgTimer(CANNM_CHANNEL_IDX, (CanNm_MsgTimerType)(CanNm_GetMsgCycleOffsetOfPbChannelConfig(CANNM_CHANNEL_IDX) + 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
      }
    }
  }
}
#endif /* #if ( CANNM_PASSIVE_MODE_ENABLED == STD_OFF) && ( CANNM_COM_CONTROL_ENABLED == STD_ON ) */
...
# if ( CANNM_BUS_LOAD_REDUCTION_ENABLED == STD_ON )
            ...
            {
              CanNm_SetMsgTimer(CANNM_CHANNEL_IDX, (CanNm_MsgTimerType)(CanNm_GetMsgReducedTimeOfPbChannelConfig(CANNM_CHANNEL_IDX) + 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
            }
...
CANNM_LOCAL_INLINE FUNC( void, CANNM_CODE ) CanNm_RepeatMessageIndHandling( CANNM_CHANNEL_TYPE_ONLY )
{
  ...
  if (CanNm_IsRepeatMsgReqFlag(CANNM_CHANNEL_IDX))
  {
    ...
    if ( CanNm_IsTxMessageData_CBVUsedOfPbChannelConfig(CANNM_CHANNEL_IDX) ) /* COV_CANNM_CHECK_CBVPOSITION */
    {
   ...
   *      Indicate the NmIf that CanNm is no longer ready to sleep
...
CANNM_LOCAL_INLINE FUNC( void, CANNM_CODE ) CanNm_WaitBusSleepTimerHandling( CANNM_CHANNEL_TYPE_ONLY )
{
   ...
   *       Do state transition to PrepareBusSleep state
   */
...
CANNM_LOCAL_INLINE FUNC( void, CANNM_CODE ) CanNm_MessageTimerHandling( CANNM_CHANNEL_TYPE_ONLY )
{
   ...
   *       otherwise Restart Tx Message Timer with MsgCycleTime
   */
 ...
 */
  CanNm_SetRepeatMsgTimer(CANNM_CHANNEL_IDX, (CanNm_RepeatMsgTimerType)(CanNm_GetRepeatMessageTimeOfChannelConfig(CANNM_CHANNEL_IDX) + 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
#if ( CANNM_REMOTE_SLEEP_IND_ENABLED == STD_ON )
  CanNm_SetRemoteSleepTimer(CANNM_CHANNEL_IDX, 0U ); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
  CanNm_SetRemoteSleepIndState(CANNM_CHANNEL_IDX, FALSE); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
#endif
...
# if ( CANNM_REPEAT_MSG_IND_ENABLED == STD_ON ) /* depends on CANNM_NODE_DETECTION_ENABLED == STD_ON */
...
#if ( CANNM_PASSIVE_MODE_ENABLED == STD_OFF )
# if ( CANNM_COM_CONTROL_ENABLED == STD_ON )
  if( CanNm_GetTxControlState(CANNM_CHANNEL_IDX) == MSG_TX_ENABLED ) /* COV_CANNM_TX_CONTROL_STATE */
# endif
  {
# if ( CANNM_IMMEDIATE_NM_TX_FEATURE_ENABLED == STD_ON )
      ...
      && (CanNm_GetNetworkRestartFlag(CANNM_CHANNEL_IDX) == CANNM_ACTIVE_RESTART) ) /* COV_CANNM_CHECK_IMMEDIATE_TRANSMISSIONS */
    {
      ...
      CanNm_SetImmediateNmMsgCount(CANNM_CHANNEL_IDX, (CanNm_ImmediateNmMsgCountType)(CanNm_GetImmediateNmTransmissionsOfChannelConfig(CANNM_CHANNEL_IDX) - 1U)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
    }
    else
# endif
    {
...
#  endif
      {
        CanNm_SetPnClusterReqExt(pnClusterRequestByte, 0x00U); /* SBSW_CANNM_CSL03 */
        CanNm_SetPnClusterReqExtNew(pnClusterRequestByte, 0x00U); /* SBSW_CANNM_PNCLUSTERREQEXTNEW */

        for( pnClusterRequestBit = 0U; pnClusterRequestBit < CANNM_PN_CLUSTERS_PER_BYTE; pnClusterRequestBit++ )
        {
          CanNm_GetPnClusterResetTimerExt(pnClusterRequestByte)[pnClusterRequestBit] = 0U; /* SBSW_CANNM_CSL_FILTERMASK_INDEX_PNCLUSTERS_PER_BYTE_INDEX_ACCESS */
        }
      }
#  if (CANNM_DEV_ERROR_REPORT == STD_ON )
      else
...
#  if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
#  else
    if( nmMinPnChannel == 0xFFu ) /* COV_CANNM_CHECK_MIN_PN_CHANNEL */
#  endif
    {
#  if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
#  else
...
#  endif
      for( pnClusterRequestByte = 0U; pnClusterRequestByte < CanNm_GetSizeOfPnFilterMask(); pnClusterRequestByte++ )
      {
        ...
        for( pnClusterRequestBit = 0U; pnClusterRequestBit < CANNM_PN_CLUSTERS_PER_BYTE; pnClusterRequestBit++ )
        {
          CanNm_GetPnClusterResetTimer(pnClusterRequestByte)[pnClusterRequestBit] = 0U; /* SBSW_CANNM_CSL_FILTERMASK_INDEX_PNCLUSTERS_PER_BYTE_INDEX_ACCESS */
        }
      }
    }
# endif
...
# if ( CANNM_COM_USER_DATA_SUPPORT == STD_ON )
  ...
  nmPduInfo.SduLength = CanNm_GetTxMessageData_UserDataLengthOfPbChannelConfig(CANNM_CHANNEL_IDX);
...
# endif
  ...
  /* ESCAN00064309 */
  SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_1(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
# endif
  ...
  /* #90 If CanIf_Transmit returns E_NOT_OK
  ...
  SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_1(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
# else
    /* ESCAN00075773 */
    CanNm_SetMsgTimeoutTimer(CANNM_CHANNEL_IDX, (CanNm_MsgTimeoutTimerType)(CanNm_GetMsgTimeoutTimeOfChannelConfig(CANNM_CHANNEL_IDX) + 1U )); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
# endif
  }
...
#if ( CANNM_TXMESSAGEDATA == STD_ON )
  for( userDataByte = CanNm_GetTxMessageDataStartIdxOfPbChannelConfig(CANNM_CHANNEL_IDX);
       userDataByte < CanNm_GetTxMessageDataEndIdxOfPbChannelConfig(CANNM_CHANNEL_IDX);
       userDataByte++ )
  {

    CanNm_SetTxMessageData(userDataByte, 0xFFu); /* SBSW_CANNM_CSL03 */
  }
#endif

#if ( CANNM_RXMESSAGEDATA == STD_ON )
  for( userDataByte = CanNm_GetRxMessageDataStartIdxOfPbChannelConfig(CANNM_CHANNEL_IDX);
       userDataByte < CanNm_GetRxMessageDataEndIdxOfPbChannelConfig(CANNM_CHANNEL_IDX);
       userDataByte++ )
  {
    CanNm_SetRxMessageData(userDataByte, 0xFFu); /* SBSW_CANNM_CSL03 */
  }
#endif
...
#  if ( CANNM_PDUNIDPOSITIONOFCHANNELCONFIG == STD_ON )
  ...
  {
    nidPosition = (uint8)(CanNm_GetTxMessageData_NIDIdxOfPbChannelConfig(CANNM_CHANNEL_IDX));
...
#  endif
  ...
  /* #70 If 'Pn Enabled' is configured and 'Pdu Cbv Position' is configured to Byte0 or Byte1
   *      Initialize CBV Byte with CRI bit set
   *     otherwise initialize CBV to zero
   */
#  if ( CANNM_PDUCBVPOSITIONOFCHANNELCONFIG == STD_ON )
  if( CanNm_IsTxMessageData_CBVUsedOfPbChannelConfig(CANNM_CHANNEL_IDX) ) /* COV_CANNM_CHECK_CBVPOSITION */
  {
    cbvPosition = (uint8)(CanNm_GetTxMessageData_CBVIdxOfPbChannelConfig(CANNM_CHANNEL_IDX));
                                                            ...
                                                            CONST( Nm_StateType, AUTOMATIC ) nextNmState )
{
  ...
  uint8 additionalTransmissionRequired = 0U; /* ESCAN00065303 */
#endif
...
#if( CANNM_ERRORWAITBUSSLEEPTIMEOFCHANNELCONFIG == STD_ON )
    if( CanNm_GetErrorWaitBusSleepTimeOfChannelConfig(CANNM_CHANNEL_IDX) > 0 )
    {
  ...
  case NM_STATE_READY_SLEEP:
     ...
     *       In any other state AND if CBV is available
...
# endif
    ...
    {
# if ( CANNM_NODE_DETECTION_ENABLED == STD_ON ) && ( CANNM_PDUCBVPOSITIONOFCHANNELCONFIG == STD_ON )
      if( CanNm_IsTxMessageData_CBVUsedOfPbChannelConfig(CANNM_CHANNEL_IDX) ) /* COV_CANNM_CHECK_CBVPOSITION */
      {
        /* ESCAN00064309 */
        CanNm_SetTxMessageData((CanNm_GetTxMessageData_CBVIdxOfPbChannelConfig(CANNM_CHANNEL_IDX)), /* SBSW_CANNM_CSL03 */
...
# endif
  ...
  default:
    ...
    /* #520 If ImmediateRestartEnabled feature is active
...
#else
  CANNM_DUMMY_STATEMENT_CONST(cannmConfigPtr); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
...
# if ( CANNM_DEV_ERROR_DETECT == STD_ON ) && ( CANNM_PBCHANNELCONFIG == STD_ON ) /* COV_CANNM_DEV_ERROR_DETECT_ON */
    ...
    /* PRQA S 3356,3359,3201 4 */ /* MD_CanNm_3356_3359,MD_MSR_14.1  */
    if( sizeOfChannelConfig != CanNm_GetSizeOfPbChannelConfig() ) /*lint !e506 */ /* COV_CANNM_INVALID_GENDATA */
    {
      errorId = CANNM_E_INVALID_GENDATA;
    }
    else
# endif
    {
...
# endif
      ...
      CanNm_SetModuleInitialized(TRUE);
#endif
    }
  }
...
#else
  CANNM_DUMMY_STATEMENT(errorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
  /* ESCAN00064309 */
#if ( CANNM_USE_ECUM_BSW_ERROR_HOOK == STD_ON )
...
#else
  CANNM_DUMMY_STATEMENT(ecumErrorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
...
#if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
  CANNM_DUMMY_STATEMENT_CONST(nmChannelHandle); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#else
  NetworkHandleType channel;
#endif
...
# if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
        ...
        || ( nmChannelHandle != CanNm_GetChannelIdOfChannelConfig(0U) ) ) /*lint !e506 */ 
  {
...
# if !defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
    channel = CanNm_GetSysToNmChInd(nmChannelHandle);
# endif
    SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_2(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    ...
    SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_2(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    retVal = E_OK;
  }
...
# if !defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
    channel = CanNm_GetSysToNmChInd(nmChannelHandle);
# endif
    SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_5(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    /* #200 Iterate all user data bytes
    ...
    SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_5(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    retVal = E_OK;
  }
...
# endif
    /* ----- Implementation ----------------------------------------------- */
    /* #200 If current state is ReadySleep or NormalOperation.
...
# endif
    /* ----- Implementation ----------------------------------------------- */
    SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_5(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
    /* #200 Iterate all data bytes of last received Nm message
...
#endif /* ( CANNM_NODE_DETECTION_ENABLED == STD_ON ) || ( CANNM_NODE_ID_ENABLED == STD_ON ) ||
...
# endif
        ...
        (CanNm_GetNmState(CANNM_CHANNEL_IDX) == NM_STATE_NORMAL_OPERATION) )
    {
      ...
      *nmRemoteSleepIndPtr = (boolean)CanNm_IsRemoteSleepIndState(CANNM_CHANNEL_IDX); /* SBSW_CANNM_CHECKREMOTESLEEPINDICATION */
      retVal = E_OK;
    }
  }
...
{
  /* #10 Set Nm state to not initialized */
  /* Note: Do not perform init check. */
#if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
  CanNm_SetNmState(0, NM_STATE_UNINIT); /* SBSW_CANNM_NMSTATE_INDEX_ACCESS */
#else
  uint8_least  channel;
  for( channel = 0U; channel < CANNM_NUMBER_OF_CANNM_CHANNELS; channel++ )
  {
    CanNm_SetNmState(channel, NM_STATE_UNINIT); /* SBSW_CANNM_NMSTATE_INDEX_ACCESS */
  }
#endif
#if ( CANNM_DEV_ERROR_DETECT == STD_ON ) /* COV_CANNM_DEV_ERROR_DETECT_ON */
  /* #20 Set global state to not initialized */
  CanNm_SetModuleInitialized(FALSE);
#endif
#if ( CANNM_USE_INIT_POINTER == STD_ON )
...
# endif
    ...
    if( CanNm_IsTxMessageData_CBVUsedOfPbChannelConfig(CANNM_CHANNEL_IDX) ) /* COV_CANNM_CHECK_CBVPOSITION */
    {
      SchM_Enter_CanNm_CANNM_EXCLUSIVE_AREA_3(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
      ...
      SchM_Exit_CanNm_CANNM_EXCLUSIVE_AREA_3(); /* PRQA S 3109 */ /* MD_MSR_14.3 */
                                             ...
                                             P2CONST( PduInfoType, AUTOMATIC, CANNM_APPL_VAR ) PduInfoPtr )
{
  ...
  NetworkHandleType channel;
        ...
        || (( CANNM_NODE_DETECTION_ENABLED == STD_ON ) && ( CANNM_PASSIVE_MODE_ENABLED == STD_OFF )) ) )
  /* local variables */
...
# endif
          (!CanNm_IsPnMessageFilterEnabled(CANNM_CHANNEL_IDX)) )
...
# if ( CANNM_NODE_DETECTION_ENABLED == STD_ON )
          if( ( CanNm_GetNmState(CANNM_CHANNEL_IDX) != NM_STATE_REPEAT_MESSAGE ) &&
...
#if ( CANNM_COORDINATOR_SYNC_SUPPORT == STD_ON )
#else
  CANNM_DUMMY_STATEMENT_CONST(PduInfoPtr); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
#if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
  CANNM_DUMMY_STATEMENT(RxPduId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
...
# if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
  CANNM_DUMMY_STATEMENT(TxPduId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
# endif
...
#  if defined ( CANNM_OPTIMIZE_CHANNEL_ENABLED )
  CANNM_DUMMY_STATEMENT(CanNmTxPduId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#  else
...
# endif
    ...
    CanNm_SetPnMessageFilterEnabled(CANNM_CHANNEL_IDX, (CanNm_PnMessageFilterEnabledType)CanNm_IsPnEnabledOfPbChannelConfig(CANNM_CHANNEL_IDX)); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
    CanNm_SetPnMessageFilterDeactivationIndicated(CANNM_CHANNEL_IDX, FALSE); /* SBSW_CANNM_CSL_CHANNEL_INDEX_ACCESS */
  }
...
FUNC( void, CANNM_CODE ) CanNm_MainFunction( void )
{
...
#endif
  {
    ...
    for( channel = 0U; channel < (NetworkHandleType)CanNm_GetSizeOfChannelConfig(); channel++ )
    {
      ...
      /* #230 Process Repeat Message Ind. (if NodeDetectionEnabled enabled) */
...
} /* CanNm_MainFunction */ /* PRQA S 2006,6010,6030,6050,6080 */ /* MD_MSR_14.7,MD_MSR_STPTH,MD_MSR_STCYC,MD_MSR_STCAL,MD_MSR_STMIF */
...
# error: "CAN NM configuration issue: Version Info Enabled has to be defined STD_OFF or STD_ON"
      ...
      ( ( CANNM_NODE_DETECTION_ENABLED == STD_OFF ) || ( CANNM_NODE_DETECTION_ENABLED == STD_ON ) ) )
...
# error: "CAN NM configuration issue: Passive Mode Enabled has to be defined STD_OFF or STD_ON"
      ...
      ( ( CANNM_NODE_ID_ENABLED == STD_OFF ) || ( CANNM_NODE_ID_ENABLED == STD_ON ) ) )
...
# error: "CAN NM configuration issue: State Change Indication Enabled has to be defined STD_OFF or STD_ON"
      ...
      ( ( CANNM_COM_CONTROL_ENABLED == STD_OFF ) || ( CANNM_COM_CONTROL_ENABLED == STD_ON ) ) )
...
# error: "CAN NM configuration issue: Bus Load Reduction Enabled has to be defined STD_OFF or STD_ON"
      ...
      ( ( CANNM_IMMEDIATE_RESTART_ENABLED == STD_OFF ) || ( CANNM_IMMEDIATE_RESTART_ENABLED == STD_ON ) ) )
# error: "CAN NM configuration issue: Immediate Restart Enabled has to be defined STD_OFF or STD_ON"
      ...
      ( ( CANNM_REPEAT_MSG_IND_ENABLED == STD_OFF ) || ( CANNM_REPEAT_MSG_IND_ENABLED == STD_ON ) ) )
...
# endif
# if ( CANNM_NODE_DETECTION_ENABLED == STD_ON )
#  error "CAN NM configuration issue: CANNM_NODE_DETECTION_ENABLED cannot be activated if CANNM_PASSIVE_MODE_ENABLED is STD_ON."
# endif
# if ( CANNM_ACTIVE_WUP_BIT_FEATURE_ENABLED == STD_ON )
...
# endif
# if ( CANNM_IMMEDIATE_RESTART_ENABLED == STD_ON )
#  error "CAN NM configuration issue: CANNM_IMMEDIATE_RESTART_ENABLED cannot be activated if CANNM_PASSIVE_MODE_ENABLED is STD_ON."
# endif
#endif
...
#if ( CANNM_NODE_DETECTION_ENABLED == STD_OFF ) && ( CANNM_REPEAT_MSG_IND_ENABLED == STD_ON )
# error "CAN NM configuration issue: CANNM_REPEAT_MSG_IND_ENABLED cannot be activated if CANNM_NODE_DETECTION_ENABLED is STD_OFF."
#endif

/* Check configuration of CBV */
#if( CANNM_PDUCBVPOSITIONOFCHANNELCONFIG == STD_OFF )
# if ( CANNM_NODE_DETECTION_ENABLED == STD_ON ) || ( CANNM_ACTIVE_WUP_BIT_FEATURE_ENABLED == STD_ON ) || ( CANNM_COORDINATOR_SYNC_SUPPORT == STD_ON )
...
# if ( CANNM_NODE_ID_ENABLED == STD_ON ) || ( CANNM_CAR_WUP_FILTER_FEATURE_ENABLED == STD_ON )
#  error "CAN NM configuration issue: 'Pdu Cbv Position' has to be configured to CANNM_PDU_BYTE0 or CANNM_PDU_BYTE1."
# endif
#endif
...
/* module specific MISRA deviations:
 ...
 MD_CanNm_3684:
      Reason:     Arrays declared without size, because size depends on configuration and is unknown here,
                  especially for link-time tables.
...
\DESCRIPTION       The pointer 'PduInfoPtr' is passed to the local functions CanNm_CopyTxMessageData, CanNm_PnFilterHandling, CanNm_DetermineDynamicPnInfoLength and CanNm_CarWakeupIndication.
\COUNTERMEASURE \N Pointer parameter is directly passed through.
...
\DESCRIPTION       Access of CanNm_TxControlState, CanNm_TxControlStateReq, CanNm_TimeoutTimer, CanNm_RemoteSleepTimer, CanNm_MsgTimer, CanNm_MsgConfirmationFlag,
                             ...
                             CanNm_CoordReadyToSleepState, CanNm_WaitBusSleepTimer, CanNm_PnMessageFilterEnabled, CanNm_MsgRequest, CanNm_PnMessageFilterEnabled,
...
\ID COV_CANNM_CHECK_MIN_PN_CHANNEL
   \ACCEPT TX
   \REASON The variable 'minPnChannel' is set to 0xFF in CanNm_Init() and set to the first PN enabled channel here. In case there is no other PN channel, this check only evaluates to TX.
...
\ID COV_CANNM_TX_CONTROL_STATE
   \ACCEPT TX
   \REASON Decision coverage is not fulfilled in case CANNM_NODE_DETECTION_ENABLED is OFF and CANNM_COM_CONTROL_ENABLED is ON.
