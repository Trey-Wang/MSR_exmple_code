###############################################################################
# File Name  : Sent_30_Icu_defs.mak                                                  #
...
###############################################################
# INTERNAL REQUIRED CONFIGURATION (in base_cfg.mak)
#
# SENT_30_ICU_MODULES       (required)  (not necessary for Vector)
# SENT_30_ICU_DRIVER_MODE   (required)  (not necessary for Vector)
# SENT_30_ICU_PROJECT_PATH  (optional)
# SENT_30_ICU_BUILD_LIBRARY (required)
...
# e.g.: $(SENT_30_ICU_CORE_PATH) = $(SSC_ROOT)\Sent_30_Icu  could be used for CPP_INCLUDE_PATH    +=  $(SENT_30_ICU_CORE_PATH)\CPP_FILES\...
SENT_30_ICU_CORE_PATH       =
# e.g.: BAWSE_OUTPUT_PATH = $(GENDATA_DIR)
SENT_30_ICU_OUTPUT_PATH     = $(GENDATA_DIR)

#SENT_30_ICU_TOOL_PATH      = $(PROJECT_ROOT)\core\com\base\gentool

# it is also possible to generate own configurations with some checks like the following example
#  ifneq ( $(SENT_30_ICU_CONFIG_PATH),)
#      SENT_30_ICU_PROJECT_PATH    = $(SENT_30_ICU_CONFIG_PATH)
#  else
#     SENT_30_ICU_PROJECT_PATH    = $(PROJECT_ROOT)\source\network\base
#  endif 
...
# e.g.: SSC_PLUGINS        += base
SSC_PLUGINS        += 
#e.g.: base_DEPENDENT_PLUGINS = 
SENT_30_ICU_DEPENDENT_PLUGINS = 
...
# e.g.: CC_INCLUDE_PATH     += $(SENT_30_ICU_CORE_PATH)
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += Sent_30_Icu
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=

#PREPROCESSOR_DEFINES+= drivermode

#drivermode_KEY       = SENT_30_ICU_MODE
#drivermode_VALUE    = $(SENT_30_ICU_DRIVER_MODE)
