###############################################################################
# File Name  : Sent_30_Icu_rules.mak                                                  #
...
#e.g.: LIBRARIES_TO_BUILD      +=    $(LIB_OUPUT_PATH)\vendorx_baselib1.$(LIB_FILE_SUFFIX)
LIBRARIES_TO_BUILD      += 
Sent_30_Icu_FILES              = 

# e.g.: CC_FILES_TO_BUILD       += $(VC_54S_SENT_SRC_PATH)\Sent_30_Icu.c
CC_FILES_TO_BUILD       += $(VC_54S_SENT_SRC_PATH)\Sent_30_Icu.c 
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
#
# In vendorx_Sent_30_Icu_cfg.mak:
# Please configure the project file:
#SENT_30_ICU_CONFIG_FILE = $(PROJECT_ROOT)\source\network\base\my_base_config.cfg

#In vendorx_base_config :
#generate_base_config:
#$(SSC_ROOT)\core\com\base\tools\baseconfiggen.exe -o $(BAS_CONFIG_FILE)
