###############################################################################
# File Name  : Sent_30_Icu_check.mak                                                 #
...
#e.g.: PREPARE_CONFIGURATION_INTERFACE     += SENT_30_ICU_MODULES 
...
# SPECIFIC
#
#ifneq ($(SENT_30_ICU_DRIVER_MODE),singlechannel)
#ifneq ($(SENT_30_ICU_DRIVER_MODE),multichannel)
#$(error The value of the variable SENT_30_ICU_DRIVER_MODE is not valid. \
