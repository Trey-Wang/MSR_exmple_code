...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
#if ((COM_SW_MAJOR_VERSION != 13U) || (COM_SW_MINOR_VERSION != 3U) || (COM_SW_PATCH_VERSION != 1U))
...
#if (COM_TXPDUINFOINDUSEDOFIPDUGROUPINFO == TRUE)
/**********************************************************************************************************************
  Com_IpduGroupStartTx
**********************************************************************************************************************/
/*! Internal comment removed.
...
# if(COM_ARRAYACCESSUSEDOFRXSIGGRPINFO == STD_ON)
  {
    ...
    for(; com_SignalGroupIndId < Com_GetRxSigGrpInfoIndEndIdxOfRxPduInfo(ComRxPduId); com_SignalGroupIndId++)
    {
      ...
      if(Com_IsArrayAccessUsedOfRxSigGrpInfo(com_SignalGroupId))        /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
      {
        ...
        VStdMemCpyRamToRam(Com_GetAddrRxSigArrayAccessSigGrpBuffer(idxShdBufferIdx), Com_GetAddrConstValueSigGrpArrayAccess(intialValueStartIdx), Com_GetRxSigArrayAccessSigGrpBufferLengthOfRxSigGrpInfo(com_SignalGroupId));  /* SBSW_COM_CSL01 */
      }
    }
  }
# endif
...
# if (COM_ARRAYACCESSUSEDOFRXSIGGRPINFO == STD_ON)
  ...
  if(Com_IsArrayAccessUsedOfRxSigGrpInfo(idxRxSigGrpInfo))      /* COV_COM_FEATURE_ALWAYS_TRUE_TX */
  {
    ...
    VStdMemCpyRamToRam(Com_GetAddrRxSigArrayAccessSigGrpBuffer(ShdBufferStartIndex), SignalSourcePtr, Com_GetRxSigArrayAccessSigGrpBufferLengthOfRxSigGrpInfo(idxRxSigGrpInfo));        /* SBSW_COM_CSL02 */
  }
...
# endif
...
#if (COM_ALWAYSACTIVERXCOMIPDUS == STD_ON)
    {
      ...
      for(idx = 0; idx < Com_GetSizeOfAlwaysActiveRxComIPdus(); idx++)
      {
        Com_DeactivateRxComIPdu(Com_GetRxPduInfoIdxOfAlwaysActiveRxComIPdus(idx));      /* SBSW_COM_CSL02 */
        Com_RxIPduGroup_ThresholdCheck();
      }
...
#if (COM_ALWAYSACTIVETXCOMIPDUS == STD_ON)
    {
      ...
      for(idx = 0; idx < Com_GetSizeOfAlwaysActiveTxComIPdus(); idx++)
      {
        Com_DeactivateTxComIPdu(Com_GetTxPduInfoIdxOfAlwaysActiveTxComIPdus(idx));      /* SBSW_COM_CSL02 */
        Com_TxIPduGroup_ThresholdCheck();
      }
...
# if(COM_ARRAYACCESSUSEDOFRXSIGGRPINFO == STD_ON)
    ...
    SchM_Enter_Com_COM_EXCLUSIVE_AREA_RX();
    {
      ...
      VStdMemCpyRamToRam(SignalGroupArrayPtr, Com_GetAddrRxSigArrayAccessSigGrpBuffer(idxShdBufferIdx), Com_GetRxSigArrayAccessSigGrpBufferLengthOfRxSigGrpInfo(SignalGroupId));        /* SBSW_COM_CSL01 */
    }
