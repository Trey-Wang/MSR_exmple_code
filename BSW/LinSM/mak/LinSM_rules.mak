...
# 2007/06/13   1.00     Aba     Initial Version of Template (1.0)             #
# 2008/04/30   1.01     fbg     Changes for ASR library support               #
# 2012/11/28   1.00.01  vismpf  Adapted to LinSM module                       #
# 2014/11/20   3.00.00  vissrk  Fixed ESCAN00079705                           #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 3.00.00                                                   #
###############################################################################
...
LinSM_FILES              = LinSM\LinSM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += LinSM\LinSM.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
