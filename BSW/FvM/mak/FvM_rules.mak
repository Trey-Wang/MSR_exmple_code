...
# --------     ---------------------     -------------------------------------#
# vishho       Heiko Huebler             Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Author  Change Id      Description                    #
# ----------   -------  ------  -------------  -------------------------------#
# 2017-01-12   1.00.00  vishho  FEATC-796      Freshness Calculation          #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += FvM
FvM_FILES                = FvM\FvM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FvM\FvM.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FvM_PBcfg.c $(GENDATA_DIR)\FvM_Lcfg.c
