...
unsigned int GetBaseAddr(void) /* PRQA S 5013 */
{
  HMODULE hModule;
  HANDLE  hProcess;
  MODULEINFO moduleInfo;
  char strDLLPath[256]; /* PRQA S 5013 */

  GetModuleFileName((HINSTANCE)&__ImageBase, strDLLPath, 255);
  hProcess = GetCurrentProcess();
  hModule = GetModuleHandle(strDLLPath);
  GetModuleInformation(hProcess, hModule, &moduleInfo, sizeof(MODULEINFO));
  return (unsigned int)(moduleInfo.lpBaseOfDll); /* PRQA S 5013 */
}
# undef CONST
                                               ...
                                               uint8 Size )
{
    ...
    ) 
  {
    ...
    P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) d = (P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA))Dst; /* PRQA S 0306 */ /* MD_Xcp_0306 */
#else
    P2VAR(uint32, AUTOMATIC, XCP_APPL_DATA) d = (P2VAR(uint32, AUTOMATIC, XCP_APPL_DATA))Dst; /* PRQA S 0306 */ /* MD_Xcp_0306 */
#endif
    P2CONST(uint32, AUTOMATIC, XCP_APPL_DATA) s = (P2CONST(uint32, AUTOMATIC, XCP_APPL_DATA))Src; /* PRQA S 0306 */ /* MD_Xcp_0306 */
...
# endif
          ...
          )
  {
    ...
    P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) d = (P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA))Dst; /* PRQA S 0306 */ /* MD_Xcp_0306 */
#else
    P2VAR(uint16, AUTOMATIC, XCP_APPL_DATA) d = (P2VAR(uint16, AUTOMATIC, XCP_APPL_DATA))Dst; /* PRQA S 0306 */ /* MD_Xcp_0306 */
#endif
    P2CONST(uint16, AUTOMATIC, XCP_APPL_DATA) s = (P2CONST(uint16, AUTOMATIC, XCP_APPL_DATA))Src; /* PRQA S 0306 */ /* MD_Xcp_0306 */
...
# endif
  ...
  {
    P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) d = (P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA))Dst; /* PRQA S 0306 */ /* MD_Xcp_0306 */
    P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) s = (P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA))Src; /* PRQA S 0306 */ /* MD_Xcp_0306 */
 ...
 */
#if defined ( C_COMP_ANSI_CANOE )
# pragma comment(lib,"Psapi.lib") /* PRQA S 3116 */ /* MD_MSR_3.4 */
#endif
