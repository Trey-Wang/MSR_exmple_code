###############################################################################
# File Name  : Cdd_Mirror_rules.mak                                           #
...
# ----------   -------  ---- -------------------------------------------------#
# 2012/01/10  1.00.00     Ssr  Initial Version of Template (1.0)              #
# 2012/08/31   1.00.01  Ssr  Update component folder                          #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.4                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Mirror
Mirror_FILES             = Mirror\Mirror.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Mirror\Mirror.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Mirror_Cfg.c $(GENDATA_DIR)\Mirror_Lcfg.c $(GENDATA_DIR)\Mirror_PBcfg.c 
