...
# --------     ---------------------     -------------------------------------#
# visphh       Phanuel Hieber            Vector Informatik GmbH               #
# vistof       Tobias Finke              Vector Informatik GmbH               #
# visjhg       Joern Herwig              Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign   Description                                    #
# ----------   -------  ------ -----------------------------------------------#
# 2016/06/23   1.00.00  visphh  Created                                       #
# 2016/08/24   1.00.01  vistof  ESCAN00091638: Changed CRYPTOCV_ to SECMOD_   #
# 2016/09/05   1.00.02  visjhg  ESCAN00091732: No changes                     #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
SECMOD_CORE_PATH        = SecMod\
SECMOD_OUTPUT_PATH      = $(GENDATA_DIR)
