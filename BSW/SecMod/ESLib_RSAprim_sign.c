 ...
 ** $URL: https://scm/svn/library-ES/branches/library-es/1.2.0-VectorInformatik/development/common/lib_es/source/ESLib_RSAprim_sign.c $
 ** $Rev: 1620 $
 ** $NoKeywords$
 **
 **
...
/****************************************************************************
 **
 ** This file contains: RSA sign primitive
...
/****************************************************************************
 **
 ** FUNCTION: esl_initSignRSA_prim
 **
 **  This function initializes the RSA signature primitive (plain version).
 **
 ** input:
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( eslt_ErrorCode ) esl_initSignRSA_prim(
...
/****************************************************************************
 **
 ** FUNCTION: esl_signRSA_prim
 **
 **  This function performs the RSA signature generation (RSA_SP1).
 **
 ** input:
 ** - workSpace:              algorithm context buffer, initialized by
 **                           esl_initWorkSpaceHeader(..) function
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( eslt_ErrorCode ) esl_signRSA_prim(
   CRYPTOCV_P2VAR_PARA( eslt_WorkSpaceRSAsig_prim ) workSpace,
   ...
   CRYPTOCV_P2VAR_PARA( eslt_Length ) signatureSize, CRYPTOCV_P2VAR_PARA( eslt_Byte ) signature )
{
   ...
   /* Call actCLib RSA private key operation */
   {
      ...
      actRETURNCODE result = actRSAPrivateKeyOperation( message, (int)messageSize, signature, &signatureLen,
