 ...
 ** $Author:: men                      $ $JustDate:: 01/05/05             $
 ** $Workfile:: actAES.c               $ $Revision:: 1620                 $
 ** $NoKeywords::                                                         $
 **
 **
...
/* Input:  Get 16-byte-block into 4-ulong-block workspace in LITTLE-endian order */
/* Output: Put LITTLE-endian order 4-ulong-block workspace into 16-byte-block */

CRYPTOCV_FUNC( void ) BlockIO( CRYPTOCV_P2CONST_PARA( void ) in, CRYPTOCV_P2VAR_PARA( void ) out )
{
   CRYPTOCV_P2CONST_PARA( actU8 ) i_ptr =
      (CRYPTOCV_P2CONST_PARA( actU8 ))in;

   CRYPTOCV_P2VAR_PARA( actU8 ) o_ptr =
      (CRYPTOCV_P2VAR_PARA( actU8 ))out;
 ...
 ** Look up tables
 ***************************************************************************/
CRYPTOCV_CONST( STATIC, unsigned char ) sbx_tab[256] =
{
...
CRYPTOCV_CONST( STATIC, unsigned char ) isb_tab[256] =
{
...
CRYPTOCV_CONST( STATIC, unsigned long ) rco_tab[10] =
{
   0x00000001,0x00000002,0x00000004,0x00000008,0x00000010,0x00000020,0x00000040,0x00000080,
   0x0000001b,0x00000036
};

#if ( actAES_SPEED_UP <= 1 )
   CRYPTOCV_CONST( STATIC, unsigned char ) pow_tab[256] =
   {
   ...
   CRYPTOCV_CONST( STATIC, unsigned char ) log_tab[256] =
   {
...
#else
   CRYPTOCV_CONST( STATIC, unsigned long ) ft_tab[4][256] =
   {
      {
   ...
   CRYPTOCV_CONST( STATIC, unsigned long ) it_tab[4][256] = {
      {
...
/****************************************************************************
 ** Local function 'f_nround' ('i_nround') used in the first 9 of 10 rounds
...
#define ff_mult_2(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) >= 0xe6 ? ((ACT_ROM_R_BYT(log_tab[(b)])) - 0xe6) : (0x19 + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))
/* ff_mult for a==3, log_tab[3]==0x01 */
#define ff_mult_3(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) == 0xfe ? 0 : (0x01 + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))
/* ff_mult for a==9, log_tab[9]==0xc7 */
#define ff_mult_9(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) >= 0x38 ? ((ACT_ROM_R_BYT(log_tab[(b)])) - 0x38) : (0xc7 + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))
/* ff_mult for a==11, log_tab[11]==0x68 */
#define ff_mult_11(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) >= 0x97 ? ((ACT_ROM_R_BYT(log_tab[(b)])) - 0x97) : (0x68 + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))
/* ff_mult for a==13, log_tab[13]==0xee */
#define ff_mult_13(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) >= 0x11 ? ((ACT_ROM_R_BYT(log_tab[(b)])) - 0x11) : (0xee + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))
/* ff_mult for a==14, log_tab[14]==0xdf */
#define ff_mult_14(b) ((actU32)( (b)==0 ? 0 : ACT_ROM_R_BYT(pow_tab[ (ACT_ROM_R_BYT(log_tab[(b)])) >= 0x20 ? ((ACT_ROM_R_BYT(log_tab[(b)])) - 0x20) : (0xdf + (ACT_ROM_R_BYT(log_tab[(b)]))) ] )))


/*---------------------------------------------------------------------------*/
#if ( actAES_SPEED_UP==0 )
/*---------------------------------------------------------------------------*/

/* encryption round function */
CRYPTOCV_FUNC( void ) f_nround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      ...
      for (i=0; i<4; ++i)
      {
        t = sbx_tab[actGetByte(bi[(n+i)&3],i)];
        t = (ff_mult_2(t)) | (t<<8) | (t<<16) | (ff_mult_3(t)<<24);
        bo[n] ^= ( i==0 ? t : actRotl(t, i<<3) );
      }
   }
}
/* decryption round function */
CRYPTOCV_FUNC( void ) i_nround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   actU32 t;
   unsigned int i, n;
   for (n=0; n<4; ++n)
   {
      bo[n] = k[n];
      for (i=0; i<4; ++i) {
         t = isb_tab[actGetByte(bi[(n-i)&3],i)];
         t = (ff_mult_14(t)) | (ff_mult_9(t)<<8) | (ff_mult_13(t)<<16) | (ff_mult_11(t)<<24);
         bo[n] ^= ( i==0 ? t : actRotl(t, i<<3) );
      }
   }
}
   ...
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      t[0] = ACT_ROM_R_BYT(sbx_tab[actGetByte(bi[n],0)]);
      t[0] = (ff_mult_2(t[0])) | (t[0]<<8) | (t[0]<<16) | (ff_mult_3(t[0])<<24);
      t[1] = ACT_ROM_R_BYT(sbx_tab[actGetByte(bi[(n+1)&3],1)]);
      t[1] = (ff_mult_3(t[1])) | (ff_mult_2(t[1])<<8) | (t[1]<<16) | (t[1]<<24);
      t[2] = ACT_ROM_R_BYT(sbx_tab[actGetByte(bi[(n+2)&3],2)]);
      t[2] = (t[2]) | (ff_mult_3(t[2])<<8) | (ff_mult_2(t[2])<<16) | (t[2]<<24);
      t[3] = ACT_ROM_R_BYT(sbx_tab[actGetByte(bi[(n+3)&3],3)]);
      t[3] = (t[3]) | (t[3]<<8) | (ff_mult_3(t[3])<<16) | (ff_mult_2(t[3])<<24);
   ...
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      t[0] = ACT_ROM_R_BYT(isb_tab[actGetByte(bi[n],0)]);
      t[0] = (ff_mult_14(t[0])) | (ff_mult_9(t[0])<<8) | (ff_mult_13(t[0])<<16) | (ff_mult_11(t[0])<<24);
      t[1] = ACT_ROM_R_BYT(isb_tab[actGetByte(bi[(n+3)&3],1)]);
      t[1] = (ff_mult_11(t[1])) | (ff_mult_14(t[1])<<8) | (ff_mult_9(t[1])<<16) | (ff_mult_13(t[1])<<24);
      t[2] = ACT_ROM_R_BYT(isb_tab[actGetByte(bi[(n+2)&3],2)]);
      t[2] = (ff_mult_13(t[2])) | (ff_mult_11(t[2])<<8) | (ff_mult_14(t[2])<<16) | (ff_mult_9(t[2])<<24);
      t[3] = ACT_ROM_R_BYT(isb_tab[actGetByte(bi[(n+1)&3],3)]);
      t[3] = (ff_mult_9(t[3])) | (ff_mult_13(t[3])<<8) | (ff_mult_11(t[3])<<16) | (ff_mult_14(t[3])<<24);
      bo[n] = t[0] ^ t[1] ^ t[2] ^ t[3] ^ k[n];
   }
}

/*---------------------------------------------------------------------------*/
#elif ( actAES_SPEED_UP==2 )
/*---------------------------------------------------------------------------*/
   ...
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      bo[n] =  ft_tab[0][actGetByte(bi[n],0)] ^
               ft_tab[1][actGetByte(bi[(n+1)&3],1)] ^
               ft_tab[2][actGetByte(bi[(n+2)&3],2)] ^
               ft_tab[3][actGetByte(bi[(n+3)&3],3)] ^ k[n];
   }
}
/* decryption round function */
CRYPTOCV_FUNC( void ) i_nround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      bo[n] =  it_tab[0][actGetByte(bi[n],0)] ^
               it_tab[1][actGetByte(bi[(n+3)&3],1)] ^
               it_tab[2][actGetByte(bi[(n+2)&3],2)] ^
               it_tab[3][actGetByte(bi[(n+1)&3],3)] ^ k[n];
   }
}
...
CRYPTOCV_FUNC( void ) f_nround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   bo[0] =  ft_tab[0][actGetByte(bi[0],0)] ^
            ft_tab[1][actGetByte(bi[1],1)] ^
            ft_tab[2][actGetByte(bi[2],2)] ^
            ft_tab[3][actGetByte(bi[3],3)] ^ k[0];
   bo[1] =  ft_tab[0][actGetByte(bi[1],0)] ^
            ft_tab[1][actGetByte(bi[2],1)] ^
            ft_tab[2][actGetByte(bi[3],2)] ^
            ft_tab[3][actGetByte(bi[0],3)] ^ k[1];
   bo[2] =  ft_tab[0][actGetByte(bi[2],0)] ^
            ft_tab[1][actGetByte(bi[3],1)] ^
            ft_tab[2][actGetByte(bi[0],2)] ^
            ft_tab[3][actGetByte(bi[1],3)] ^ k[2];
   bo[3] =  ft_tab[0][actGetByte(bi[3],0)] ^
            ft_tab[1][actGetByte(bi[0],1)] ^
            ft_tab[2][actGetByte(bi[1],2)] ^
            ft_tab[3][actGetByte(bi[2],3)] ^ k[3];
}
/* decryption round function */
CRYPTOCV_FUNC( void ) i_nround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   bo[0] =  it_tab[0][actGetByte(bi[0],0)] ^
            it_tab[1][actGetByte(bi[3],1)] ^
            it_tab[2][actGetByte(bi[2],2)] ^
            it_tab[3][actGetByte(bi[1],3)] ^ k[0];
   bo[1] =  it_tab[0][actGetByte(bi[1],0)] ^
            it_tab[1][actGetByte(bi[0],1)] ^
            it_tab[2][actGetByte(bi[3],2)] ^
            it_tab[3][actGetByte(bi[2],3)] ^ k[1];
   bo[2] =  it_tab[0][actGetByte(bi[2],0)] ^
            it_tab[1][actGetByte(bi[1],1)] ^
            it_tab[2][actGetByte(bi[0],2)] ^
            it_tab[3][actGetByte(bi[3],3)] ^ k[2];
   bo[3] =  it_tab[0][actGetByte(bi[3],0)] ^
            it_tab[1][actGetByte(bi[2],1)] ^
            it_tab[2][actGetByte(bi[1],2)] ^
            it_tab[3][actGetByte(bi[0],3)] ^ k[3];
}
...
/****************************************************************************
 ** Local function 'f_lround' ('i_lround') used in the last of 10 rounds
 ** of encryption (decryption).
 ***************************************************************************/
   ...
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      ...
      for (i=0; i<4; ++i)
      {
         bo[n] ^= ( ((actU32)ACT_ROM_R_BYT(sbx_tab[actGetByte(bi[(n+i)&3],i)])) << (i<<3) );
      }
   }
}
/* last decryption round function */
CRYPTOCV_FUNC( void ) i_lround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   unsigned int i, n;
   for (n=0; n<4; ++n)
   {
      ...
      for (i=0; i<4; ++i)
      {
         bo[n] ^= ( ((actU32)ACT_ROM_R_BYT(isb_tab[actGetByte(bi[(n-i)&3],i)])) << (i<<3) );
      }
   }
}
   ...
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      bo[n] =  (actU32)sbx_tab[actGetByte(bi[n],0)] ^
               actRotl(((actU32)sbx_tab[actGetByte(bi[(n+1)&3],1)]),  8) ^
               actRotl(((actU32)sbx_tab[actGetByte(bi[(n+2)&3],2)]), 16) ^
               actRotl(((actU32)sbx_tab[actGetByte(bi[(n+3)&3],3)]), 24) ^ k[n];
   }
}
/* last decryption round function */
CRYPTOCV_FUNC( void ) i_lround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   ...
   for (n=0; n<4; ++n)
   {
      bo[n] =  (actU32)isb_tab[actGetByte(bi[n],0)] ^
               actRotl(((actU32)isb_tab[actGetByte(bi[(n+3)&3],1)]),  8) ^
               actRotl(((actU32)isb_tab[actGetByte(bi[(n+2)&3],2)]), 16) ^
               actRotl(((actU32)isb_tab[actGetByte(bi[(n+1)&3],3)]), 24) ^ k[n];
   }
}
...
CRYPTOCV_FUNC( void ) f_lround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   bo[0] =           (actU32)sbx_tab[actGetByte(bi[0],0)] ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[1],1)]),  8) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[2],2)]), 16) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[3],3)]), 24) ^ k[0];
   bo[1] =           (actU32)sbx_tab[actGetByte(bi[1],0)] ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[2],1)]),  8) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[3],2)]), 16) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[0],3)]), 24) ^ k[1];
   bo[2] =           (actU32)sbx_tab[actGetByte(bi[2],0)] ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[3],1)]),  8) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[0],2)]), 16) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[1],3)]), 24) ^ k[2];
   bo[3] =           (actU32)sbx_tab[actGetByte(bi[3],0)] ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[0],1)]),  8) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[1],2)]), 16) ^
            actRotl(((actU32)sbx_tab[actGetByte(bi[2],3)]), 24) ^ k[3];
}
/* last decryption round function */
CRYPTOCV_FUNC( void ) i_lround(
   CRYPTOCV_P2VAR_PARA( actU32 ) bo, CRYPTOCV_P2CONST_PARA( actU32 ) bi, CRYPTOCV_P2CONST_PARA( actU32 ) k )
{
   bo[0] =           (actU32)isb_tab[actGetByte(bi[0],0)] ^
            actRotl(((actU32)isb_tab[actGetByte(bi[3],1)]),  8) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[2],2)]), 16) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[1],3)]), 24) ^ k[0];
   bo[1] =           (actU32)isb_tab[actGetByte(bi[1],0)] ^
            actRotl(((actU32)isb_tab[actGetByte(bi[0],1)]),  8) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[3],2)]), 16) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[2],3)]), 24) ^ k[1];
   bo[2] =           (actU32)isb_tab[actGetByte(bi[2],0)] ^
            actRotl(((actU32)isb_tab[actGetByte(bi[1],1)]),  8) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[0],2)]), 16) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[3],3)]), 24) ^ k[2];
   bo[3] =           (actU32)isb_tab[actGetByte(bi[3],0)] ^
            actRotl(((actU32)isb_tab[actGetByte(bi[2],1)]),  8) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[1],2)]), 16) ^
            actRotl(((actU32)isb_tab[actGetByte(bi[0],3)]), 24) ^ k[3];
}
...
#define ls_box(x)                            \
   (((actU32)ACT_ROM_R_BYT(sbx_tab[actGetByte((x), 0)])) ^    \
   ((actU32)ACT_ROM_R_BYT(sbx_tab[actGetByte((x), 1)]) <<  8) ^    \
   ((actU32)ACT_ROM_R_BYT(sbx_tab[actGetByte((x), 2)]) << 16) ^    \
   ((actU32)ACT_ROM_R_BYT(sbx_tab[actGetByte((x), 3)]) << 24))
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( actRETURNCODE ) actAESKeySetup(
   ...
   CRYPTOCV_P2FUNC( CRYPTOCV_NONE, void, watchdog )( void ) )
{
   ...
   else
   {
      ...
      CRYPTOCV_P2VAR_PARA( actU32 ) e_key = info->e_key;
      actU32 t;
      int i, j, key_dword_len, iterations;

      /* read key into dwords */
      info->key_dword_len = key_dword_len = key_len/4;
      for (i=0; i<key_dword_len; ++i)
      {
         e_key[i] = key[i*4] | (actU32)(key[i*4+1]) << 8 | (actU32)(key[i*4+2]) << 16 | (actU32)(key[i*4+3]) << 24;
      }

      /* key expansion loop */
      iterations = (4*key_dword_len+24)/key_dword_len;
      t = e_key[key_dword_len-1];
      for( i = 0; i < iterations; ++i )
      {
         actL2trigger( watchdog );

         t = actRotr(t, 8); t = ls_box(t) ^ ACT_ROM_R_DWD(rco_tab[i]);
         for( j = 0; j < key_dword_len; ++j )
         {
            if ( (j == 4) && (key_dword_len == 8) )
            {
               t = e_key[8*i+4] ^ ls_box(t); e_key[8*i+12] = t;
            }
            else
            {
               t ^= e_key[key_dword_len*i+j]; e_key[key_dword_len*i+key_dword_len+j] = t;
            }
         }
      }
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( void ) actAESMakeDecryptionKey( CRYPTOCV_P2VAR_PARA( actAESSTRUCT ) info )
{
   CRYPTOCV_P2VAR_PARA( actU32 ) e_key = info->e_key;
   actU32 t, u, v, w;
   int i, iterations = 4*info->key_dword_len + 24;
   ...
   for( i = 4; i < iterations; ++i )
   {
      ...
      w = star_x(v);
      t = w ^ e_key[i];
      e_key[i] = u ^ v ^ w ^ actRotr(u^t, 8) ^ actRotr(v^t, 16) ^ actRotr(t, 24);
   }
}
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( actRETURNCODE ) actAESInit(
   CRYPTOCV_P2VAR_PARA( actAESSTRUCT ) info, CRYPTOCV_P2CONST_PARA( actU8 ) key, int key_len,
   ...
   CRYPTOCV_P2FUNC( CRYPTOCV_NONE, void, watchdog )( void ) )
{
   ...
   switch (mode & actAES_BM_MASK)
   {
      ...
      case actAES_BM_CBC:
      {
         if (iv == 0)
         {
            actMemset(info->prev_block, 0, actAES_BLOCK_SIZE);
         }
         else
         {
            actMemcpy(info->prev_block, iv, actAES_BLOCK_SIZE);
         }
 ...
 **
 ** FUNCTION:
 ** void actAESEncryptMultipleBlocks()
 **
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( void ) actAESEncryptMultipleBlocks(
...
{
   CRYPTOCV_P2VAR_PARA( actU8 ) prev_block = info->prev_block;
   int i, bcount;
   ...
   switch (info->mode & actAES_BM_MASK)
   {
      case actAES_BM_CBC:
      {
         for (bcount = 0; bcount < blocks; ++bcount)
         {
            ...
            for (i = 0; i < actAES_BLOCK_SIZE; ++i)
            {
               out_buffer[i] = (actU8)(prev_block[i] ^ *in++);
            }
            /* out_block = Encrypt(out_block) */
            actAESEncryptBlock(info, out_buffer, out_buffer, watchdog);
      ...
      default:   /* ECB */
      {
         for (bcount = 0; bcount < blocks; ++bcount, in += actAES_BLOCK_SIZE, out_buffer += actAES_BLOCK_SIZE)
         {
            /* out_block = Encrypt(in_block) */
            actAESEncryptBlock(info, in, out_buffer, watchdog);
         }
 ...
 **
 ** FUNCTION:
 ** void actAESDecryptMultipleBlocks()
 **
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( void ) actAESDecryptMultipleBlocks(
   CRYPTOCV_P2VAR_PARA( actAESSTRUCT ) info,
   CRYPTOCV_P2CONST_PARA( actU8 ) in, CRYPTOCV_P2VAR_PARA( actU8 ) out_buffer,
   int blocks, CRYPTOCV_P2FUNC( CRYPTOCV_NONE, void, watchdog )( void ) )
{
   ...
   switch (info->mode & actAES_BM_MASK)
   {
      case actAES_BM_CBC:
      {
        for (bcount=0; bcount < blocks; ++bcount)
        {
            ...
            actMemcpy(temp, in, actAES_BLOCK_SIZE);

            /* out_block = Decrypt(in_block) */
            actAESDecryptBlock(info, in, out_buffer, watchdog);
 ...
 **
 ***************************************************************************/
CRYPTOCV_FUNC( void ) actAESTransform(
   CRYPTOCV_P2VAR_PARA( actAESSTRUCT ) info,
   ...
   CRYPTOCV_P2FUNC( CRYPTOCV_NONE, void, watchdog )( void ) )
{
   ...
   if ( info->buffer_used>0 ) {
      diff = actMin(in_length, (int)(actAES_BLOCK_SIZE-info->buffer_used));
      actMemcpy(info->buffer+info->buffer_used, in, (unsigned int)diff);
      ...
      if( info->buffer_used < actAES_BLOCK_SIZE ) {
         ...
         if (transform == actAESEncryptMultipleBlocks)
            actAESEncryptMultipleBlocks(info, info->buffer, out_buffer, 1, watchdog);
         else
            actAESDecryptMultipleBlocks(info, info->buffer, out_buffer, 1, watchdog);
#else
         transform(info, info->buffer, out_buffer, 1, watchdog);
#endif
         in += diff; out_buffer += actAES_BLOCK_SIZE;
      }
   }
...
#ifdef actNO_INDIRECT_CALLS
   if (transform == actAESEncryptMultipleBlocks)
      actAESEncryptMultipleBlocks(info, in, out_buffer, blocks, watchdog);
   else
      actAESDecryptMultipleBlocks(info, in, out_buffer, blocks, watchdog);
#else
   ...
   actMemcpy(info->buffer, in+bytes, (unsigned int)(info->buffer_used));
}
