...
LIBRARIES_TO_BUILD      += Gpt
Gpt_FILES                = VttGpt\Gpt.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttGpt\Gpt.c VttGpt\Gpt_Irq.c VttCntrl\VttCntrl_Gpt.c 
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Gpt_PBcfg.c $(GENDATA_DIR)\VttCntrl_Gpt_Cfg.c
