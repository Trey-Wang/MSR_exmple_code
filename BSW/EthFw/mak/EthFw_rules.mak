...
# --------     ---------------------     -------------------------------------# 
# vispcn       Philipp Christmann        Vector Informatik GmbH               # 
#-----------------------------------------------------------------------------# 
#               R E V I S I O N   H I S T O R Y                               # 
#-----------------------------------------------------------------------------# 
# Date         Version  Sign    Description                                   # 
# ----------   -------  ------  ----------------------------------------------# 
# 2016-08-10   1.00.00  vispcn  Created                                       # 
#-----------------------------------------------------------------------------# 
# TemplateVersion = 1.0                                                       # 
# MAKEFILE        = 0.1                                                       # 
############################################################################### 
...
# REGISTRY 
# 
LIBRARIES_TO_BUILD      += EthFw
EthFw_FILES              = EthFw\EthFw.c

ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthFw\EthFw.c
endif
CPP_FILES_TO_BUILD      += 
ASM_FILES_TO_BUILD      += 
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\EthFw_Lcfg.c
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\EthFw_PBcfg.c
