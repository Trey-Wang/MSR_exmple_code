...
# --------     ---------------------     -------------------------------------#
# Wge           Wladimir Gerber              Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date           Version  Sign   Description                                      #
# ----------   -------  ----   -------------------------------------------------#
# 15/03/04     1.00      Wge   Initial Version                                                 #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += VttCntrl
VttCntrl_FILES               = VttCntrl\VttCntrl_Det.c VttCntrl\VttCntrl_Base.c VttCntrl\VttCntrl_SysVar.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttCntrl\VttCntrl_Det.c VttCntrl\VttCntrl_Base.c VttCntrl\VttCntrl_SysVar.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\VttCntrl_SysVar_Cfg.c
