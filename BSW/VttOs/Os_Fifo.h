...
#if !defined(OS_FIFO_H)                                                                                                 /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_FIFO_H
...
# if !defined(OS_VCAST_INSTRUMENTATION_OS_FIFO)
...
))
{
  ...
  Os_FifoIdxIncrement(&WriteIdx, Size);                                                                                 /* SBSW_OS_FC_POINTER2ARGUMENT */
...
))
{
  ...
  return ((WriteIdx < Size) && (ReadIdx < Size));                                                                       /* COV_OS_INVSTATE */
}
