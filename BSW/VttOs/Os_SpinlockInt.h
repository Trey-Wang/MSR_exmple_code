...
#if !defined(OS_SPINLOCKINT_H)                                                                                          /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_SPINLOCK_CASTDYN_SPINLOCK_2_LOCK(spinlock)                                                                  \
      (&((spinlock).Lock))                                                                                              /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *
 *  \trace        CREQ-167, CREQ-40, CREQ-261
 ...
 *
 *  \trace        CREQ-139, CREQ-40, CREQ-261
