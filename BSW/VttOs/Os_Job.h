...
#if !defined(OS_JOB_H)                                                                                                  /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_JOB_H
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_JOB)
...
{
  Os_Assert((Os_StdReturnType)(LeftJob->Counter == RightJob->Counter));
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)(Job_1->Counter == Job_2->Counter));
}
 ...
 *  Os_JobGetValue()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TickType, OS_CODE,                                                      /* PRQA S 3219 */ /* MD_Os_3219 */
