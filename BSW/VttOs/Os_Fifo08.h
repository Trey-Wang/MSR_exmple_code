...
#if !defined(OS_FIFO08_H)                                                                                               /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_FIFO08_H
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_FIFO08)
...
))
{
  ...
  /* #10 Perform checks. */
  if(OS_LIKELY(Os_Fifo08IsFull(Fifo) == 0))                                                                             /* SBSW_OS_FC_PRECONDITION */
  {
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint8, OS_CODE, OS_ALWAYS_INLINE,                                          /* PRQA S 3219 */ /* MD_Os_3219 */
Os_Fifo08Dequeue,
(
  P2CONST(Os_Fifo08ReadConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
{
  ...
  /* #10 Perform checks. */
  Os_Assert((Os_StdReturnType)(Os_Fifo08IsEmpty(Fifo) == 0));                                                           /* SBSW_OS_FC_PRECONDITION */
