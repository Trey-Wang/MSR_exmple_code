...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_SCHEDULE((OS_TRACE_INVALID_THREAD)               ,
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_FORCED_TERMINATION((KilledIsr->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    if(IsTaskSuspended == 0)
    {
      ...
      OS_VTH_FORCED_TERMINATION((KilledTask->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))
