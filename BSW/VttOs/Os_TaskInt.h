...
#define OS_TASK_CASTDYN_TASK_2_THREAD(task)                      (&((task).Thread))                                     /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_TaskConfigType to Os_TaskConfigType by use of base element addressing. */
#define OS_TASK_CASTCONFIG_TASK_2_TASK(task)                     (&(task))                                              /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
typedef enum
{
  OS_TASKSCHEDULE_ALLOWED   /*! Calling Schedule is allowed for the task. */
}Os_TaskScheduleType;
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2CONST(Os_CoreAsrConfigType, TYPEDEF, OS_CONST), OS_CODE, OS_ALWAYS_INLINE,
Os_TaskGetCore,
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task
));
 ...
 *
 *  \trace        CREQ-42, CREQ-40, CREQ-261, CREQ-846
 ...
 *
 *  \trace        CREQ-101, CREQ-40, CREQ-261
 ...
 *  \pre          See ChainTask().
 *
 *  \trace        CREQ-121, CREQ-40, CREQ-846, CREQ-261
 ...
 *  \pre          See Schedule().
 *
 *  \trace        CREQ-126, CREQ-40, CREQ-261
