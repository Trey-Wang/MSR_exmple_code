...
# --------     ---------------------     -------------------------------------# 
# visdmi       Dennis Mueller            Vector Informatik GmbH               # 
#-----------------------------------------------------------------------------# 
#               R E V I S I O N   H I S T O R Y                               # 
#-----------------------------------------------------------------------------# 
# Date         Version  Sign Description                                      # 
# ----------   -------  ---- -------------------------------------------------# 
# 2013-10-29   1.00.00  Dmi  Created                                          # 
#-----------------------------------------------------------------------------# 
# TemplateVersion = 1.0                                                       # 
# MAKEFILE        = 0.1                                                       # 
############################################################################### 
...
# REGISTRY 
# 
LIBRARIES_TO_BUILD      += AvTp
AvTp_FILES             = AvTp\AvTp.c

ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += AvTp\AvTp.c
endif
CPP_FILES_TO_BUILD      += 
ASM_FILES_TO_BUILD      += 
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\AvTp_Lcfg.c
