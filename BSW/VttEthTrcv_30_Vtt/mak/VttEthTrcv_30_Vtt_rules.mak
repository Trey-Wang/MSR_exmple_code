###############################################################################
# File Name  : EthTrcv_30_Vtt_rules.mak                                       #
...
# ----------   ------- ------  -----------------------------------------------#
# 2015/03/05   2.00.00 vismha  Initial creation                               #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += EthTrcv_30_Vtt
EthTrcv_30_Vtt_FILES     = VttEthTrcv_30_Vtt\EthTrcv_30_Vtt.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       +=
else
CC_FILES_TO_BUILD       += VttEthTrcv_30_Vtt\EthTrcv_30_Vtt.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\EthTrcv_30_Vtt_Lcfg.c $(GENDATA_DIR)\EthTrcv_30_Vtt_HwStub.c
