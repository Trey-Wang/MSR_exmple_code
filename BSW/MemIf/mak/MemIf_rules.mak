...
# Lg           Peter Lang                Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
...
# 2007/08/14   1.01     Lg   Makefile modified for Asr Component If_AsrIfMem  #
...
LIBRARIES_TO_BUILD      += MemIf
MemIf_FILES             = MemIf\MemIf.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += MemIf\MemIf.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\MemIf_Cfg.c
