###############################################################################
# File Name  : LinTrcv_30_Tle7259dio_rules.mak                                #
...
# ----------   -------  ---- -------------------------------------------------#
# 2010/02/09   1.00.01  Eta  Initial Version                                  #
# 2013/04/15   2.00.00  Eta  Removed LinTrcv_30__Your_Trcv__LCfg.c            #
# 2017/03/30   2.01.00  Neb  Changed placeholders with GenericLin name        #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LinTrcv_30_Generic_FILES    = LinTrcv_30_Generic\LinTrcv_30_Generic.c


# e.g.: CC_FILES_TO_BUILD += drv\can_drv.c
CC_FILES_TO_BUILD       += LinTrcv_30_Generic\LinTrcv_30_Generic.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
