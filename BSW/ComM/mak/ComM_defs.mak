###############################################################################
# File Name  : <ASRMODULENAME>_defs.mak                                       #
...
# --------     ---------------------     -------------------------------------#
# vispet       Thomas Kuhl               Vector Informatik GmbH               #
# vismih       Michael Schligerski       Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
...
# 2013-04-12   1.01.00  vismih  No changes here                               #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.01.00                                                   #
###############################################################################
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += ComM $(GENDATA_DIR)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
