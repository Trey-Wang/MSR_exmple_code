...
# 2016/08/19   1.02.00  Bmz  added access via wildcard, FEAT1842              #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Eep
Eep_FILES                = VttEep\Eep.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       +=  VttEep\Eep.c VttCntrl\VttCntrl_Eep.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  +=  $(wildcard $(GENDATA_DIR)/Eep_*.c) $(GENDATA_DIR)\VttCntrl_Eep_Cfg.c
