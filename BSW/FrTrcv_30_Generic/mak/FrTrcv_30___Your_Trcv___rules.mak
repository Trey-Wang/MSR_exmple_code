...
# 2007/08/14   1.01     Ces  Adapted to AUTOSAR CanTrcv                       #
# 2008/02/05   1.02     Hr   Adapted to AUTOSAR FrTrcv                        #
# 2008/04/30   1.03     fbg  Changes for ASR library support                  #
# 2009/04/21   1.04     Ore  Renamed FrTrcv to FrTrcv_Tja1080                 #
# 2009/11/16   1.05     lo   no usage of template c files                     #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
CC_FILES_TO_BUILD       += FrTrcv_30_Generic\FrTrcv_30___Your_Trcv__.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
