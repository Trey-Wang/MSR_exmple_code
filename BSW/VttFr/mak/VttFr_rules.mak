...
CC_FILES_TO_BUILD       += VttFr\Fr.c VttFr\Fr_Irq.c VttCntrl\VttCntrl_Fr.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Fr_PBcfg.c $(GENDATA_DIR)\Fr_Lcfg.c $(GENDATA_DIR)\VttCntrl_Fr_Cfg.c
...
#generate_can_config:
#$(SSC_ROOT)\core\com\can\tools\canconfiggen.exe -o $(FR_CONFIG_FILE)
