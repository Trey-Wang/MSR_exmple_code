...
LIBRARIES_TO_BUILD      += Dio
Dio_FILES                = VttDio\Dio.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttDio\Dio.c VttCntrl\VttCntrl_Dio.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Dio_PBcfg.c $(GENDATA_DIR)\VttCntrl_Dio_Cfg.c 
