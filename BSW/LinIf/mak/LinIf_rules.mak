...
# 2008/04/30   1.01.01  fbg  Changes for ASR library support                  #
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\LinIf_PBcfg.c $(GENDATA_DIR)\LinIf_Lcfg.c

ifeq ($(LINIF_USE_LINTP),1)
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\LinTp_PBcfg.c $(GENDATA_DIR)\LinTp_Lcfg.c
endif
