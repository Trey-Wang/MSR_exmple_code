...
# ----------   -------    ---- -----------------------------------------------#
# 2015/12/11   1.00.00    Ade  Initial Version                                #
# 2016/07/22   1.00.01    Ade  ESCAN00091114: Incorrect filename used         #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
CddDrm_FILES             = CddDrm\CddDrm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CddDrm\CddDrm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
