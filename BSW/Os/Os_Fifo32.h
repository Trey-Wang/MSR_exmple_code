...
#if !defined(OS_FIFO32_H)                                                                                               /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_FIFO32_H
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_FIFO32)
...
OS_ALWAYS_INLINE, Os_Fifo32IndicesInRangeOnWrite,
(
  P2CONST(Os_Fifo32WriteConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
{
...
))
{
  ...
  /* #10 Perform checks. */
  if(OS_LIKELY(Os_Fifo32IsFull(Fifo) == 0))                                                                             /* SBSW_OS_FC_PRECONDITION */
  {
...
OS_ALWAYS_INLINE, Os_Fifo32IsFull,
(
  P2CONST(Os_Fifo32WriteConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
{
 ...
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,                                                 /* PRQA S 3219 */ /* MD_Os_3219 */
OS_ALWAYS_INLINE, Os_Fifo32IndicesInRangeOnRead,
(
  P2CONST(Os_Fifo32ReadConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
{
...
))
{
  ...
  /* #10 Perform checks. */
  Os_Assert((Os_StdReturnType)(Os_Fifo32IsEmpty(Fifo) == 0));                                                           /* SBSW_OS_FC_PRECONDITION */
 ...
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CONST,                                                /* PRQA S 3219 */ /* MD_Os_3219 */
OS_ALWAYS_INLINE, Os_Fifo32IsEmpty,
(
  P2CONST(Os_Fifo32ReadConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
{
