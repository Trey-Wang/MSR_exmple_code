...
#if !defined (OS_BITARRAYINT_H)                                                                                         /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_BITARRAY_LENGTH(BitSize)   ((BitSize) + 1)                                                                   /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! \brief    Calculates the number of required bit fields.
 *  \details  --no details--
 *  \param[in]      BitSize   Number of bits which shall be reserved */
#define OS_BITARRAY_SIZE(BitSize)  \
  ((OS_BITARRAY_LENGTH(BitSize)/OS_BITFIELD_BITWIDTH) + 1)                                                              /* PRQA S 3410, 3453 */ /* MD_Os_3410_Decl, MD_Os_3453_Decl */
...
#define  OS_BITARRAY_DECLARE(Name, BitSize, MemClass)   VAR(Os_BitFieldType, MemClass)                                 \
  Name[OS_BITARRAY_SIZE(BitSize)]                                                                                       /* PRQA S 3410, 3453 */ /* MD_Os_3410_Decl, MD_Os_3453_Decl */
