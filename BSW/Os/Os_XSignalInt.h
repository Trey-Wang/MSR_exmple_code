...
#if !defined(OS_XSIGNALINT_H)                                                                                           /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_XSIGNAL_CASTCONFIG_XSIGNALISR_2_ISR(isr)      (&((isr).IsrCfg))                                              /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
struct Os_XSigFunctionTableConfigType_Tag
{
  ...
  Os_XSigFunctionDescritorConfigType FunctionDescription[OS_XSIGFUNCTIONIDX_USEDCOUNT+1];
};
