...
#if !defined(OS_THREAD_TYPES_H)                                                                                         /* PRQA S 0883 */ /* MD_Os_0883 */
...
# define OS_CALLCONTEXT_TASK              ((Os_CallContextType)(1u <<  0))
/*! Call context ID for Category 2 ISRs. */
# define OS_CALLCONTEXT_ISR2              ((Os_CallContextType)(1u <<  1))
/*! Call context ID for Error Hooks. */
# define OS_CALLCONTEXT_ERRORHOOK         ((Os_CallContextType)(1u <<  2))
/*! Call context ID for PreTask Hooks. */
# define OS_CALLCONTEXT_PRETASKHOOK       ((Os_CallContextType)(1u <<  3))
/*! Call context ID for PostTask Hooks. */
# define OS_CALLCONTEXT_POSTTASKHOOK      ((Os_CallContextType)(1u <<  4))
/*! Call context ID for Startup Hooks. */
# define OS_CALLCONTEXT_STARTUPHOOK       ((Os_CallContextType)(1u <<  5))
/*! Call context ID for Shutdown Hooks. */
# define OS_CALLCONTEXT_SHUTDOWNHOOK      ((Os_CallContextType)(1u <<  6))
/*! Call context ID for Alarm Callbacks. */
# define OS_CALLCONTEXT_ALARMCALLBACK     ((Os_CallContextType)(1u <<  7))
/*! Call context ID for Protection Hooks. */
# define OS_CALLCONTEXT_PROTECTIONHOOK    ((Os_CallContextType)(1u <<  8))
/*! Call context ID for Pre-Start Tasks. */
# define OS_CALLCONTEXT_PRESTARTTASK      ((Os_CallContextType)(1u <<  9))
/*! Call context ID for Timing Protection ISR. */
# define OS_CALLCONTEXT_TPISR             ((Os_CallContextType)(1u << 10))
/*! Call context ID for Callbacks. */
# define OS_CALLCONTEXT_IOCCALLBACK       ((Os_CallContextType)(1u << 11))
/*! Call context ID for Init Hooks. */
# define OS_CALLCONTEXT_INITHOOK          ((Os_CallContextType)(1u << 12))
