...
#if !defined(OS_XSIGNAL_H)                                                                                              /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_XSIGNAL_H
...
{
  return (OS_CFG_XSIGNAL == STD_ON);
}

/***********************************************************************************************************************
 *  Os_XSigUseAsynchronous()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,                                                 /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
OS_ALWAYS_INLINE, Os_XSigUseAsynchronous,
(
  void
))                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  return (OS_CFG_XSIG_USEASYNC == STD_ON);
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StatusType, OS_CODE,                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED *//* PRQA S 3219 */ /* MD_Os_3219 */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StatusType, OS_CODE, OS_ALWAYS_INLINE,                                  /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED *//* PRQA S 3219 */ /* MD_Os_3219 */
Os_XSigSend_HookCallCallbackAsync,
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) RecvCore,
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) SendThread,
