...
#if !defined(OS_COUNTERINT_H)                                                                                           /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_COUNTER_CASTCONFIG_TIMERSW_2_COUNTER(timer)          (&((timer).Counter))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_TimerPitConfigType to Os_CounterConfigType by use of base element addressing. */
#define OS_COUNTER_CASTCONFIG_TIMERPIT_2_COUNTER(timer)                                                                \
    (&((timer).SwCounter.Counter))                                                                                      /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_TimerHrtConfigType to Os_CounterConfigType by use of base element addressing. */
#define OS_COUNTER_CASTCONFIG_TIMERHRT_2_COUNTER(timer)         (&((timer).Counter))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *
 *  \trace        CREQ-156, CREQ-40, CREQ-261
