...
#if !defined(OS_ALARMINT_H)                                                                                             /* PRQA S 0883 */ /* MD_Os_0883 */
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_ALARM)
...
#define OS_ALARM_CASTDYN_ALARM_2_JOB(alarm)                       (&((alarm).Job))                                      /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_AlarmActivateTaskConfigType to Os_AlarmConfigType by use of base element addressing. */
#define OS_ALARM_CASTCONFIG_ALARMACTIVATETASK_2_ALARM(alarm)      (&((alarm).Alarm))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_AlarmSetEventConfigType to Os_AlarmConfigType by use of base element addressing. */
#define OS_ALARM_CASTCONFIG_ALARMSETEVENT_2_ALARM(alarm)          (&((alarm).Alarm))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_AlarmIncrementCounterConfigType to Os_AlarmConfigType by use of base element addressing. */
#define OS_ALARM_CASTCONFIG_ALARMINCREMENTCOUNTER_2_ALARM(alarm)  (&((alarm).Alarm))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */


/*! Type cast from Os_AlarmCallbackConfigType to Os_AlarmConfigType by use of base element addressing. */
#define OS_ALARM_CASTCONFIG_ALARMCALLBACK_2_ALARM(alarm)          (&((alarm).Alarm))                                    /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre          See SetRelAlarm().
 *
 *  \trace        CREQ-116, CREQ-40, CREQ-261
 ...
 *  \pre          See CancelAlarm().
 *
 *  \trace        CREQ-164, CREQ-40, CREQ-261
