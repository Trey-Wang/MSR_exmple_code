...
#if !defined(OS_SCHEDULETABLEINT_H)                                                                                     /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_SCHT_CASTCONFIG_SCHT_2_SCHT(schT)                (&(schT))                                                   /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Type cast from Os_SchTSyncConfigType to Os_SchTConfigType by use of base element addressing. */
#define OS_SCHT_CASTCONFIG_SCHTSYNC_2_SCHT(schT)            (&((schT).SchT))                                            /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Type cast from Os_SchTType to Os_JobType by use of base element addressing. */
#define OS_SCHT_CASTDYN_SCHT_2_JOB(schT)                    (&((schT).Job))                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Type cast from Os_SchTSyncType to Os_JobType by use of base element addressing. */
#define OS_SCHT_CASTDYN_SCHTSYNC_2_JOB(schT)                (&((schT).SchT.Job))                                        /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Dummy cast to make generator's life easier. */
#define OS_SCHT_CASTCONFIG_SCHTEXPO_2_SCHTEXPO(exPo)        (&(exPo))                                                   /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Type cast from Os_SchTSyncType to Os_SchTExPoConfigType by use of base element addressing. */
#define OS_SCHT_CASTCONFIG_SCHTEXPOSYNC_2_SCHTEXPO(exPo)    (&((exPo).ExPo))                                            /* PRQA S 3453 */ /* MD_MSR_19.7 */

/***********************************************************************************************************************
 *  GLOBAL DATA TYPES AND STRUCTURES
 **********************************************************************************************************************/
/*! \brief    Identifies an event in a list of ExPo Events.
 *  \details  The number of events, which may be activated by a single expiry point is limited to 255
 *            (allowed range from 0..254). */
typedef uint8_least Os_SchTEventIdxType;
 ...
 *
 *  \trace        CREQ-136, CREQ-40, CREQ-261
 ...
 *
 *  \trace        CREQ-112, CREQ-40, CREQ-261
 ...
 *
 *  \trace        CREQ-100, CREQ-40, CREQ-261
 ...
 *
 *  \trace        CREQ-152, CREQ-40, CREQ-261
 ...
 *
 *  \trace        CREQ-108, CREQ-40, CREQ-261
