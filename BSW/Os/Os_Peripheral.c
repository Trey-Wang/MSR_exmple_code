...
))
{
  ...
  return OsCfg_PeripheralRefs[PeripheralID];                                                                            /* PRQA S 3689 */ /* MD_Os_3689 */
}
...
{
  return (Os_StdReturnType) (   (((const uint8*)Address) >=  ((const uint8*)Peripheral->AddressStart))
                             && (((const uint8*)Address) <= (((const uint8*)Peripheral->AddressEnd) - (Size - 1) )));   /* PRQA S 0488 */ /* MD_Os_488_PeripheralAddress */
}
...
)
{
  ...
  Os_PeripheralCheck08(PeripheralID, Address);                                                                          /* SBSW_OS_PP_PERIPHERALCHECK */
...
)
{
  ...
  /* #10 Perform error checks. */
  Os_PeripheralCheck16(PeripheralID, Address);                                                                          /* SBSW_OS_PP_PERIPHERALCHECK */
...
)
{
  ...
  /* #10 Perform error checks. */
  Os_PeripheralCheck32(PeripheralID, Address);                                                                          /* SBSW_OS_PP_PERIPHERALCHECK */
