...
#if !defined(OS_FIFOREF_H)                                                                                              /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_FIFOREF_H
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_FIFOREF)
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_FifoWriteResultType, OS_CODE, OS_ALWAYS_INLINE,                         /* PRQA S 3219 */ /* MD_Os_3219 */
Os_FifoRefEnqueue,
(
  P2CONST(Os_FifoRefWriteConfigType, AUTOMATIC, OS_APPL_DATA) Fifo,
...
))
{
  ...
  /* #10 Perform checks. */
  if(OS_LIKELY(Os_FifoRefIsFull(Fifo) == 0))                                                                            /* SBSW_OS_FC_PRECONDITION */
  {
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CONST, OS_ALWAYS_INLINE,                              /* PRQA S 3219 */ /* MD_Os_3219 */
Os_FifoRefIsFull,
(
  P2CONST(Os_FifoRefWriteConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
...
{
  /* #10 Perform checks. */
  Os_Assert((Os_StdReturnType)(Os_FifoRefIsEmpty(Fifo) == 0));                                                          /* SBSW_OS_FC_PRECONDITION */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CONST, OS_ALWAYS_INLINE,                                          /* PRQA S 3219 */ /* MD_Os_3219 */
Os_FifoRefEmptyQueue,
(
  P2CONST(Os_FifoRefReadConfigType, AUTOMATIC, OS_APPL_DATA) Fifo
))
