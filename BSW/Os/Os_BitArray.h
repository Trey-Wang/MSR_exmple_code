...
#if !defined (OS_BITARRAY_H)                                                                                            /* PRQA S 0883 */ /* MD_Os_0883 */
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_BITARRAY)
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_BitArrayIndexType, OS_CODE,                                             /* PRQA S 3219 */ /* MD_Os_3219 */
...
{
  return (Os_BitArrayIndexType)(BitIdx < BitArray->BitLength);
}
...
))
{
  ...
  return (Os_BitArrayIndexType)(BitArrayIdx & ((Os_BitArrayIndexType)((1 << Os_BitArrayGetIndexBitwidth()) - 1)));
}
...
))
{
  ...
  Os_Assert((Os_StdReturnType)(BitArray->Size > 0));
  Os_Assert((Os_StdReturnType)(BitArray->BitLength > 1));
  ...
  Os_BitArraySetBitInternal(BitArray, BitArray->BitLength-1);                                                           /* SBSW_OS_FC_PRECONDITION */
}
 ...
 * */
  ...
  Os_Assert(Os_BitArrayIdxIsValid(BitArray, BitIdx+1));                                                                 /* SBSW_OS_FC_PRECONDITION */
...
))
{
  ...
  if(BitArray->Data[allocationIdx] == 0)
  {
    BitArray->Dyn->AllocationMask &= (~(OS_BITFIELD_MASK_MSB >> allocationIdx));                                        /* SBSW_OS_BA_BITARRAYGETDYN_001 */
  }
}
