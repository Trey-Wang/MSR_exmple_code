...
#if ( ( 0x02u != CANSM_SW_MAJOR_VERSION ) || ( 0x13u != CANSM_SW_MINOR_VERSION ) || ( 0x00u != CANSM_SW_PATCH_VERSION ) )
...
#define CANSM_SD_RAMCHECK_END                 0x62u
#define CANSM_SD_CHECK_RAM                    0x61u
 ...
 *
 *  \param[in]    CanSM_NetworkHandle           ComM network handle of current CanSM channel
 *  \param[in]    CanSM_CurrentChannelVarPtr    Pointer to channel specific variable structure
 *  \context      ANY
 *  \reentrant    TRUE for different networks
 *  \config       -
 ...
 *  \note         Called by CanSM_RequestComMode CanSM_ControllerModeIndication and CanSM_MainFunction
 **********************************************************************************************************************/
CANSM_LOCAL FUNC(void, CANSM_CODE) CanSM_NoComReached( NetworkHandleType CanSM_NetworkHandle, P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr );
...
/**********************************************************************************************************************
  CanSM_BswMIndication()
 **********************************************************************************************************************/
/*! \brief        Encapsulates the notification of BswM
 *  \details      Calls the BswM_CanSM_CurrentState() function
 *  \param[in]    CanSM_CanNetworkIdx           Can network index
 *  \param[in]    CanSM_CurrentChannelVarPtr    Pointer to channel specific variable structure
 *  \param[in]    CanSM_BswMState                State which is indicated to the BswM
 *  \context      ANY
 *  \reentrant    TRUE for different networks
 *  \synchronous  TRUE
 *  \config       -
 ...
 *  \trace        -
 *********************************************************************************************************************/
CANSM_LOCAL_INLINE FUNC(void, CANSM_CODE) CanSM_BswMIndication( CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx, P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr, uint8 CanSM_BswMState );

#if ( CANSM_SWIFT_TX_TIMEOUT_RECOVERY == STD_ON )
/**********************************************************************************************************************
  CanSM_CheckTxTimeout()
 **********************************************************************************************************************/
/*! \brief        Encapsulates the notification in case of transmission timeout exception handling
 *  \details      Calls the BswM_CanSM_CurrentState() and ComM_BusSM_ModeIndication function
 *  \param[in]    CanSM_CanNetworkIdx           Can network index
 *  \param[in]    CanSM_CurrentChannelVarPtr    Pointer to channel specific variable structure
 *  \context      ANY
 *  \reentrant    TRUE for different networks
 *  \synchronous  TRUE
 *  \config       CANSM_SWIFT_TX_TIMEOUT_RECOVERY
 *  \pre          -
 *  \trace        -
 *********************************************************************************************************************/
CANSM_LOCAL_INLINE FUNC(void, CANSM_CODE) CanSM_CheckTxTimeout( CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx, P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr );
...
#if ( CANSM_PARTIAL_NETWORK_WAKEUP_FILTEROFCHANNELCONFIG != STD_ON )
  CANSM_DUMMY_STATEMENT( CanSM_BusOffLevel ); /* PRQA S 3112 */ /* MD_MSR_14.2 */
#endif /* ( CANSM_PARTIAL_NETWORK_WAKEUP_FILTEROFCHANNELCONFIG != STD_ON ) */
  CANSM_DUMMY_STATEMENT( CanSM_CanNetworkIdx ); /* might be unreferenced due to ComStackLib optimization */ /* PRQA S 3112 */ /* MD_MSR_14.2 */
...
{ /* Context: CanSM_Init, CanSM_InitializeVariables; CanSM_MainFunction, CanSM_EvaluateComModeRequest CanSM_MainFunction, CanSM_EvaluateMaxModeRequests CanSM_TxTimeoutException, no bus-off */
  ...
  BswM_CanSM_CurrentState( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), CanSM_BswMState );
  (*CanSM_CurrentChannelVarPtr).CanSM_BswMIndicatedState = CanSM_BswMState; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */

  CANSM_DUMMY_STATEMENT( CanSM_CanNetworkIdx ); /* PRQA S 3112 */ /* MD_MSR_14.2 */
...
{ /*  Context: NWSM; CANSM_BO_TX_OFFLINE timer elapsed, CanSM_CtrlStartedIndicated after startup resp. no BOR CanSM_HandleComModeRequest; from SILENT to FULL;;    CanSM_FullComReached; withOUT new raw pending BusOff */
  ...
  CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_FULL_COMMUNICATION ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */

  CanSM_SetCanIfPduModeFullCom( CanSM_CanNetworkIdx, (*CanSM_CurrentChannelVarPtr).CanSM_BusOffCounter );

  (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_FULL_COMMUNICATION; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  ...
  if ( CanSM_IsBor_Tx_Confirmation_PollingOfChannelConfig( CanSM_CanNetworkIdx ) )
  {
    (*CanSM_CurrentChannelVarPtr).CanSM_UniversalTimer = CANSM_CANCEL_TIMER; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  }
  else
...
{ /* Context: CanSM_BusOffIndicated; new raw bus-off */
  ...
  CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_BUS_OFF ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  /* \trace..SPEC-11324 */

  (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_SILENT_COMMUNICATION; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  ComM_BusSM_ModeIndication( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), &( (*CanSM_CurrentChannelVarPtr ).CanSM_IndicatedComMode ) ); /* SBSW_CANSM_COMMMODEINDICATION_CALL */
  /* \trace..SPEC-11416 */

#if ( CANSM_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG == STD_ON )
# if ( CANSM_ISDEF_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG == STD_ON )
  CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PREFAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
# else /* CANSM_ISDEF_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG */
  if ( CanSM_IsProdErrorDetect_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ) )
  {
    CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PREFAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
  }
...
{ /* Context: CanSM_Init, CanSM_InitializeVariables; CanSM_MainFunction, CanSM_EvaluateComModeRequest CanSM_MainFunction, CanSM_EvaluateMaxModeRequests CanSM_TxTimeoutException, no bus-off */
  ...
  if ( (*CanSM_CurrentChannelVarPtr).CanSM_BswMIndicatedState != CANSM_BSWM_NO_COMMUNICATION )
  { /* avoid redundant indication, even BswM can deal with */
    CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_NO_COMMUNICATION ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
    /* \trace..SPEC-11365 */
  }
  (*CanSM_CurrentChannelVarPtr).CanSM_UniversalTimer = CANSM_CANCEL_TIMER; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */

#if defined CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_MIXED_ON_AND_OFF
  if ( CanSM_IsPartial_Network_Trcv_SupportOfChannelConfig( CanSM_CanNetworkIdx ) )
...
#endif /* ( CANSM_EXPANDED_TX_TIMEOUT_RECOVERY == STD_OFF ) */
  (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutEndIndicationFlag = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutFlag = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
...
{ /* Context: Called by CanSM_Init */
  ...
  (*CanSM_CurrentChannelVarPtr).CanSM_BswMIndicatedState = CANSM_BSWM_NO_COMMUNICATION; /* Avoids BswM indication in CanSM_InitiateShutDownSequence   */ /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutEndIndicationFlag = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
...
#if ( CANSM_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG == STD_ON )
# if ( CANSM_ISDEF_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG == STD_ON )
  CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PASSED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
# else /* CANSM_ISDEF_PRODERRORDETECT_BUSOFF_OFCHANNELCONFIG */
  if ( CanSM_IsProdErrorDetect_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ) )
  {
    CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_BusOff_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PASSED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
{ /* Context: CanSM_ControllerModeIndication, CANIF_CS_STARTED received in state CANSM_SU_CC_STARTED */
  ...
  else if ( (*CanSM_CurrentChannelVarPtr).CanSM_BusOffCounter == CANSM_BOR_NONE )
#else
...
#if ( CANSM_ECU_PASSIVE_MODE == STD_ON )
    SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_5(); /* RequestComMode MainFunction SetEcuPassive */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
#endif /* CANSM_ECU_PASSIVE_MODE == STD_ON  */
...
#if ( CANSM_ECU_PASSIVE_MODE == STD_ON )
    SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_5(); /* PRQA S 3109 */ /* MD_MSR_14.3  */
#endif /* CANSM_ECU_PASSIVE_MODE == STD_ON  */
  }
  else
  { /* E_TX_OFF */
...
{ /* Context: CanSM_ControllerModeIndication, CANIF_CS_STOPPED received */
  ...
  if ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_SU_CC_STOPPED )
  {
    ...
    { /* E_CHANGE_BAUDRATE CANSM_BSM_S_CHANGE_BAUDRATE */
      ...
      (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_NO_COMMUNICATION; /* CBR  END; */ /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
      ComM_BusSM_ModeIndication( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), &( (*CanSM_CurrentChannelVarPtr ).CanSM_IndicatedComMode ) ); /* SBSW_CANSM_COMMMODEINDICATION_CALL */
      /* \trace..SPEC-11339 */
...
# if defined CANSM_SD_CC_SLEEP_NON_PN_CHANNELS_TRCV_MIXED
    if ( CanSM_IsTransceiver_Channel_SupportOfChannelConfig( CanSM_CanNetworkIdx ) )
...
# endif /* Trcv ID runtime check, mixed on off */
    {
      ...
      CanSM_NoComReached( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), CanSM_CurrentChannelVarPtr );  /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
...
# if ( CANSM_ISDEF_PRODERRORDETECT_MODEREQUEST_OFCHANNELCONFIG == STD_ON )
    CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_ModeRequest_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_FAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
# else /* CANSM_ISDEF_PRODERRORDETECT_MODEREQUEST_OFCHANNELCONFIG */
    if ( CanSM_IsProdErrorDetect_ModeRequest_OfChannelConfig( CanSM_CanNetworkIdx ) )
    {
      CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventId_ModeRequest_OfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_FAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
    }
#  if ( CANSM_DEV_ERROR_REPORT == STD_ON )
...
{ /* Context: CanSM_RequestComMode, valid */
...
#endif /* ( ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) || ( CANSM_PARTIAL_NETWORK_WAKEUP_FILTEROFCHANNELCONFIG == STD_ON ) ) */
  {
    ...
    SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_2(); /* MainFunction( ) ControllerModeIndication( ) TransceiverModeIndication( ) ClearTrcvWufFlagIndication( ) CheckTransceiverWakeFlagIndication( ) TxTimeoutException( ) SetEcuPassive( ) StartWakeupSources( ) StopWakeupSources( )  */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
    ...
    else if ( ( CanSM_RequestedComMMode != COMM_FULL_COMMUNICATION ) && ( ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState & CANSM_S_NO_BUS_OFF ) == CANSM_S_NO_BUS_OFF ) ) /* Meta FullCom */ /* CANSM_S_FULLCOM CANSM_BO_BUS_OFF_CHECK CANSM_S_NO_BUS_OFF    CANSM_S_FULLCOM_ENSURED CANSM_BO_TX_OFFLINE  */ /* PRQA S 0715 2 */ /* MD_MSR_1.1 */
    {
    ...
    SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_2(); /* PRQA S 3109 */ /* MD_MSR_14.3  */
...
{  /* Context: CanSM_TransceiverModeIndication CanSM_ClearTrcvWufFlagIndication CanSM_CheckTransceiverWakeFlagIndication CanSM_ConfirmPnAvailability */
  ...
  CANSM_DUMMY_STATEMENT( CanSM_TransceiverId ); /* might be unreferenced due to ComStackLib optimization */ /* PRQA S 3112 */ /* MD_MSR_14.2 */
 ...
 */
CANSM_LOCAL_INLINE FUNC(void, CANSM_CODE) CanSM_BusOffIndicated( CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx )
{ /* Context: CanSM_ControllerBusOff */
  P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr = CanSM_GetAddrChannelVarRecord( CanSM_CanNetworkIdx );
  ...
  SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_3(); /* RequestComMode( ) ControllerBusOff( ) TxTimeoutException( ) */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
  if ( ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_BO_BUS_OFF_CHECK ) || ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_S_NO_BUS_OFF ) )
  {
    CanSM_FullComToRestartController( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  }
  SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_3(); /* PRQA S 3109 */ /* MD_MSR_14.3  */
 ...
 */
CANSM_LOCAL_INLINE FUNC(void, CANSM_CODE) CanSM_CheckTxTimeout( CanSM_SizeOfChannelVarRecordType CanSM_CanNetworkIdx, P2VAR(CanSM_ChannelVarRecordType, AUTOMATIC, CANSM_VAR_NOINIT) CanSM_CurrentChannelVarPtr )
{ /* Context: CanSM_NetworkStatemachine */

  if ( (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutFlag == TRUE )
  { /* CanSM_TxTContextFirstTry failed */
    (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutFlag = FALSE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */

    CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_NO_COMMUNICATION ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */  /* NoCom used as fall back solution for CANSM_BSWM_TX_TIMEOUT */
    (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_SILENT_COMMUNICATION; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
    ComM_BusSM_ModeIndication( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), &( (*CanSM_CurrentChannelVarPtr ).CanSM_IndicatedComMode ) ); /* SBSW_CANSM_COMMMODEINDICATION_CALL */
  }
...
{ /* Context: CanSM_Init or Mainfunc, NW SM, SD RAM check */
  ...
  switch ( (*CanSM_CurrentChannelVarPtr).CanSM_RamCheckState )
  {
    ...
    default: /* PRQA S 2003 */ /* MD_CANSM_15.2 */
...
{ /* Context: CanSM_RequestComMode, CanSM_HandleComModeRequest; Meta state FullCom CanSM_CtrlStartedIndicated, CanSM_FullComReached pending Silent request */
  ...
  /* \trace..SPEC-11310 */
  /* \trace..SPEC-11383 */
  CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_SILENT_COMMUNICATION ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
  /* \trace..SPEC-11401 */
...
{ /* Context: CanSM_CheckTransceiverWakeFlagIndication; state CANSM_SD_CHK_WUF_CC_SLEEP CanSM_CtrlSleepIndicated; noPN noTrcv CanSM_TrcvStandbyIndicatedAsExpected; noPN */
  ...
  {
    (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_NO_COMMUNICATION; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
    ComM_BusSM_ModeIndication( CanSM_NetworkHandle, &( (*CanSM_CurrentChannelVarPtr ).CanSM_IndicatedComMode ) ); /* SBSW_CANSM_COMMMODEINDICATION_CALL */
    /* \trace..SPEC-11340 */
    /* \trace..SPEC-2181146 */
  }
...
# endif /*   CANSM_TRANSCEIVER_HANDLING_ALWAYS_ON  */
      ...
      case CANSM_SU_CC_STARTED:
      {
        ...
        if ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState != CANSM_SU_CC_STARTED )
...
#endif /* if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
      case CANSM_SU_CC_STOPPED: /* PRQA S 2003 */ /* MD_CANSM_15.2 */
      {
...
#endif /* ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_ALWAYS_ON ) */
#if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON )
      case CANSM_SD_CC_SLEEP_PN: /* PRQA S 2003 */ /* MD_CANSM_15.2 */ /* BullsEye; if overall report blames unapproachable, it is a lie */
#endif  /* not always OFF ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
      {
...
#if ( CANSM_TRANSCEIVER_CHANNEL_SUPPORTOFCHANNELCONFIG == STD_ON )
      case CANSM_SD_TRCV_NORMAL: /* PRQA S 2003 */ /* MD_CANSM_15.2 */
      {
        CanSM_RetValTriggerFunc = CanIf_SetTrcvMode( CanSM_GetTransceiverIdOfChannelConfig( CanSM_CanNetworkIdx ), CANTRCV_TRCVMODE_NORMAL );

        break; /* PRQA S 3333 */ /* MD_CANSM_14.6 */
      } /* end case CANSM_SD_TRCV_NORMAL */
      case CANSM_SD_TRCV_STANDBY: /* PRQA S 2003 */ /* MD_CANSM_15.2 */
      {
...
# endif /* if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
      ...
      { /* case CANSM_SD_CC_STOPPED */
        /* \trace..SPEC-11361 */
        (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_SD_CC_STOPPED; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_4(); /* CanIR BO */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
        ...
        SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_4(); /* CanIR BO */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
...
#if ( CANSM_SWIFT_TX_TIMEOUT_RECOVERY == STD_ON )
  CanSM_CheckTxTimeout( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
#endif /* CANSM_SWIFT_TX_TIMEOUT_RECOVERY */

  CANSM_DUMMY_STATEMENT( CanSM_CanNetworkIdx );  /* PRQA S 3112 */ /* MD_MSR_14.2 */

} /* end  Func CanSM_NetworkStatemachine */  /* PRQA S 6030, 6050 */  /* MD_MSR_STCYC, MD_MSR_STCYC */ 
...
{ /* \trace SPEC-834 */
  ...
  CANSM_DUMMY_STATEMENT_CONST(ConfigPtr); /* PRQA S 3112 */ /* MD_MSR_14.2 */
  ...
  CANSM_DUMMY_STATEMENT( CanSM_DetErrorId ); /* PRQA S 3112 */ /* MD_MSR_14.2 */
...
{ /* \trace SPEC-853 */
  ...
  if ( CanSM_IsInitialized == CANSM_INITFUNCTION_FINISHED )
  {
    ...
    for ( CanSM_CanNetworkIdx = 0; CanSM_CanNetworkIdx < CanSM_GetSizeOfChannelVarRecord(); CanSM_CanNetworkIdx++ ) /* lint +e442 +e440 */
    {
      ...
      SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_1(); /* RequestComMode( ) StartWakeupSources( ) StopWakeupSources( ) ControllerBusOff( ) TxTimeoutException( ) SetEcuPassive( )  */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
      ...
      SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_1(); /* PRQA S 3109 */ /* MD_MSR_14.3  */
...
} /* end Func CanSM_RequestComMode() */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
{ /* \trace SPEC-837 */
...
#endif /* CANSM_DEV_ERROR_DETECT  */
  {
...
#endif /* CANSM_DEV_ERROR_DETECT  */
    {
      ...
      CanSM_StdReturnValue = E_OK;
      *CanSM_ComMModePtr   = CanSM_GetChannelVarRecord( CanSM_CanNetworkIdx ).CanSM_IndicatedComMode; /* SBSW_CANSM_GETCURRENTCOMMODE_POINTERWRITEACCESS */
      /* \trace SPEC-839 */
...
# else /* CANSM_DEV_ERROR_REPORT */
  CANSM_DUMMY_STATEMENT( CanSM_DetErrorId ); /* PClint: not accessed, not used. GHS: was set but never used */ /* PRQA S 3112 */ /* MD_MSR_14.2 */
#endif /* end if ( CANSM_DEV_ERROR_REPORT == STD_ON ) */

} /* end Func CanSM_ControllerBusOff() */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
FUNC(void, CANSM_CODE) CanSM_SetEcuPassive( boolean CanSM_TxOfflineActive )
{
  ...
  if ( CanSM_EcuPassiveMode != CanSM_TxOfflineActive )
  {
    ...
    for ( CanSM_CanNetworkIdx = 0; CanSM_CanNetworkIdx < CanSM_GetSizeOfChannelVarRecord(); CanSM_CanNetworkIdx++ ) /* lint +e442 +e440 */
    {
      ...
      SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_5(); /* RequestComMode MainFunction */ /* PRQA S 3109 */ /* MD_MSR_14.3  */
...
# else /* CANSM_USE_INIT_POINTER */
  CANSM_DUMMY_STATEMENT( CanSM_NetworkHandle ); /* PRQA S 3112 */ /* MD_MSR_14.2 */
  CanSM_StdReturnValue = E_NOT_OK;
# endif /* CANSM_USE_INIT_POINTER */
...
# endif /* CANSM_DEV_ERROR_DETECT  */
    {
      ...
      SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_4(); /* PRQA S 3109 */ /* MD_MSR_14.3  */
...
} /* end Func CanSM_ControllerModeIndication */ /* PRQA S 6080 */ /* MD_MSR_STMIF   */
...
} /* end Func CanSM_TransceiverModeIndication */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
#endif /* if ( CANSM_TRANSCEIVER_CHANNEL_SUPPORTOFCHANNELCONFIG == STD_ON ) */
...
} /* End Func CanSM_ClearTrcvWufFlagIndication   () */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
} /* End Func CanSM_CheckTransceiverWakeFlagIndication() */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
#endif /* end   else if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
...
# endif /* CANSM_DEV_ERROR_DETECT  */
    {
      ...
      if ( (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState == CANSM_S_FULLCOM_ENSURED ) /* CANSM_S_NO_BUS_OFF */
      {
        ...
        (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_SU_CC_STOPPED; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        /* \trace..SPEC-47154 */
        CanSM_BswMIndication( CanSM_CanNetworkIdx, CanSM_CurrentChannelVarPtr, CANSM_BSWM_CHANGE_BAUDRATE ); /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        /* \trace..SPEC-11328 */
        CanSM_StdReturnValue = E_OK;
        /* \trace..SPEC-47141 */
      }
...
} /* End Func CanSM_SetBaudrate() */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
} /* End Func CanSM_CheckBaudrate () */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
#endif /* CANSM_DEV_ERROR_DETECT  */
  {
...
#endif /* CANSM_DEV_ERROR_DETECT  */
    {
         ...
         )
      {
        ...
        (*CanSM_CurrentChannelVarPtr).CanSM_CurrentState = CANSM_SU_CC_STOPPED; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        (*CanSM_CurrentChannelVarPtr).CanSM_UniversalTimer = CANSM_CANCEL_TIMER; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
        (*CanSM_CurrentChannelVarPtr).CanSM_TxTimeoutFlag = TRUE; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
#endif /* CANSM_SWIFT_TX_TIMEOUT_RECOVERY */
        /* \trace..SPEC-47114 */
...
} /* end Func CanSM_TxTimeoutException */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
...
} /* end Func CanSM_ConfirmPnAvailability */ /* PRQA S 2006 */ /* MD_MSR_14.7 */
#endif /* end  else  if ( CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG == STD_ON ) */
...
# endif /* if ( CANSM_TRANSCEIVER_CHANNEL_SUPPORTOFCHANNELCONFIG == STD_ON ) */
          ...
          if ( (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode != COMM_NO_COMMUNICATION )
          {
            (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode = COMM_NO_COMMUNICATION; /* SBSW_CANSM_CHANNEL_STRUCT_ACCESS */
            ComM_BusSM_ModeIndication( CanSM_GetNetworkHandleOfChannelConfig( CanSM_CanNetworkIdx ), &( (*CanSM_CurrentChannelVarPtr ).CanSM_IndicatedComMode ) ); /* SBSW_CANSM_COMMMODEINDICATION_CALL */
            /* BswM_CanSM_CurrentState(NoCom) already informed at begin of the shut down sequence */
          } /* wakeup during running shut down; NoCom Indication missing */
...
} /* end CanSM_StartWakeupSources */ /* PRQA S 2006, 6080 */ /* MD_MSR_14.7, MD_MSR_STMIF */
...
# endif /* CANSM_PARTIAL_NETWORK_TRCV_SUPPORT_MIXED_ON_AND_OFF */
      {
        ...
        if ( (*CanSM_CurrentChannelVarPtr).CanSM_RequestedComMode == COMM_NO_COMMUNICATION )
        {
          ...
          if ( (*CanSM_CurrentChannelVarPtr).CanSM_IndicatedComMode == COMM_NO_COMMUNICATION )
          {
            CanSM_IsInitialized = CANSM_STOPWAKEUPSOURCES_RUNNING;
          }
...
# endif /* end if ( CANSM_DEV_ERROR_REPORT == STD_ON ) */
  ...
  CANSM_DUMMY_STATEMENT( CanSM_NetworkHandle ); /* PRQA S 3112 */ /* MD_MSR_14.2 */
  CANSM_DUMMY_STATEMENT( WakeupSource ); /* PRQA S 3112 */ /* MD_MSR_14.2 */

  return CanSM_StdReturnValue; /* more than one 'return' path */ /* Network valid; found in configuration; stop searching, stop for-loop */

} /* end CanSM_StopWakeupSources */ /* PRQA S 2006, 6080 */ /* MD_MSR_14.7, MD_MSR_STMIF */
