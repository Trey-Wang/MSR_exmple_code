...
# define CCL_ASR4SMCAN_VERSION                                        0x0213u   /* BCD coded version number */
 ...
 * \length LONG This exclusive area calls to other BSW modules.
 * \endexclusivearea
 *
 * \exclusivearea CANSM_EXCLUSIVE_AREA_2
 * Ensures consistency while performing state changes
 * \protects CanSM_RequestComMode
 ...
 * Ensures consistency while performing state changes
 * \protects CanSM_ControllerBusOff
 ...
 * Ensures consistency while performing state changes
 * \protects Set controller mode
 * \usedin CanSM_MainFunction(), CanSM_RequestComMode()
 ...
 * Ensures consistency while performing state changes
 * \protects CanSM_MainFunction
 * \usedin CanSM_SetEcuPassive(), CanSM_StartWakeupSources(), CanSM_StopWakeupSources()
 * \exclude CanSM_RequestComMode(), CanSM_MainFunction()
 * \length LONG This exclusive area calls to other BSW modules.
 * \endexclusivearea
 *
 * \exclusivearea CANSM_EXCLUSIVE_AREA_5
 * Ensures consistency while performing state changes
 * \protects CanSM_ControllerModeIndication
 * \usedin CanSM_SetEcuPassive()
 * \exclude CanSM_RequestComMode(), CanSM_ControllerBusOff(), CanSM_TxTimeoutException(), CanSM_SetEcuPassive(), CanSM_StopWakeupSources(), CanSM_StartWakeupSources()
 * \length LONG This exclusive area calls to other BSW modules.
 * \endexclusivearea
 *
