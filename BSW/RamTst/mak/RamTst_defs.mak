...
# 2011/05/16   1.01     Cer  Adaption for SysService_AsrRamTst                #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
RAMTST_CORE_PATH       =   $(SSC_ROOT)\RamTst


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


RAMTST_OUTPUT_PATH     =   $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(RAMTST_CORE_PATH)  $(RAMTST_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
