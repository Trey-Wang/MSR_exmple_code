...
LIBRARIES_TO_BUILD      += RamTst
RamTst_FILES               = RamTst\RamTst.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += RamTst\RamTst.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\RamTst_Lcfg.c
