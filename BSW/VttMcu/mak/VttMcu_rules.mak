...
LIBRARIES_TO_BUILD      += Mcu
Mcu_FILES                = VttMcu\Mcu.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttMcu\Mcu.c VttCntrl\VttCntrl_Mcu.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Mcu_PBcfg.c
