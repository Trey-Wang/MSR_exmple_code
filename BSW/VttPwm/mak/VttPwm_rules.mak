...
# 2015/07/14   1.01.00  Chl  Update of CC_FILES_TO_BUILD and                  #
...
LIBRARIES_TO_BUILD      += Pwm
Pwm_FILES                = VttPwm\Pwm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttPwm\Pwm.c VttPwm\Pwm_Irq.c VttCntrl\VttCntrl_Pwm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Pwm_PBcfg.c $(GENDATA_DIR)\VttCntrl_Pwm_Cfg.c
