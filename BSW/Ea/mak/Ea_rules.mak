...
# 2007/08/14   1.01     Pp   Changes of ASR2.1 make files                     #
# 2008/04/30   1.02     fbg  Changes for ASR library support                  #
# 2010/10/18   1.03     Du   added supprot of Ea_30_Inst2                     #
# 2012/04/16   1.04     lo   remove filtering of Ea_30_Inst2                  #
# 2013/02/15   1.05		Du	 Ea_Lcfg.c ==> Ea_Cfg.c                           #
# 2015/04/16   1.05.00  Gmi  New source files were added due to SafeBSW       #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
Ea_FILES                = Ea\Ea.c Ea\Ea_PartitionHandler.c Ea\Ea_BlockHandler.c \
Ea\Ea_DatasetHandler.c Ea\Ea_InstanceHandler.c Ea\Ea_TaskManager.c Ea\Ea_EepCoordinator.c \
Ea\Ea_Layer1_Read.c Ea\Ea_Layer1_Write.c Ea\Ea_Layer1_Erase.c Ea\Ea_Layer1_Invalidate.c \
Ea\Ea_Layer2_WriteInstance.c Ea\Ea_Layer2_InvalidateInstance.c Ea\Ea_Layer2_InstanceFinder.c \
Ea\Ea_Layer3_ReadManagementBytes.c



# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Ea\Ea.c Ea\Ea_PartitionHandler.c Ea\Ea_BlockHandler.c Ea\Ea_DatasetHandler.c \
Ea\Ea_InstanceHandler.c Ea\Ea_TaskManager.c Ea\Ea_EepCoordinator.c Ea\Ea_Layer1_Read.c Ea\Ea_Layer1_Write.c \
Ea\Ea_Layer1_Erase.c Ea\Ea_Layer1_Invalidate.c Ea\Ea_Layer2_WriteInstance.c Ea\Ea_Layer2_InvalidateInstance.c \
Ea\Ea_Layer2_InstanceFinder.c Ea\Ea_Layer3_ReadManagementBytes.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
