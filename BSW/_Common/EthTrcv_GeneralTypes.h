...
/* ETHTRCV MII modes */
# define ETHTRCV_MII_MODE                              (0U)
# define ETHTRCV_LIGHT_MII_MODE                        (1U)
# define ETHTRCV_RMII_MODE                             (2U)
# define ETHTRCV_RMII_XTAL_MODE                        (3U)
# define ETHTRCV_GMII_MODE                             (4U)
# define ETHTRCV_RGMII_MODE                            (5U)
# define ETHTRCV_RGMII_XTAL_MODE                       (6U)
# define ETHTRCV_STRAPPING_CONFIG_ONLY                 (7U)
# define ETHTRCV_DONT_CARE                          (0xFFU)

/* ETHTRCV CONN NEG modes*/
# define ETHTRCV_CONN_NEG_AUTO                         (0U)
# define ETHTRCV_CONN_NEG_MASTER                       (1U)
# define ETHTRCV_CONN_NEG_SLAVE                        (2U)
# define ETHTRCV_CONN_NEG_MANUAL                       (3U)

# define ETHTRCV_PHYS_ADDR_LEN_BYTE                    (6U)
