...
#  else
  detStatus.unlockBreak = TRUE; /* PRQA S 3201 */ /* MD_DET_3201 */
#  endif
# endif
}
 ...
 *
 **********************************************************************************************************************/
FUNC(void, DET_CODE) Det_Init( CONSTP2CONST( Det_ConfigType, AUTOMATIC, DET_CONST ) ConfigPtr ) /* PRQA S 1503 */ /* MD_MSR_14.1 */
{
# if (DET_DEBUG_ENABLED == STD_ON)
...
# endif
  ...
  DET_DUMMY_STATEMENT_CONST(ConfigPtr);  /* is never used */ /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
...
#  if (DET_FORWARD_TO_DLT == STD_OFF) && (DET_ERROR_HOOK_ENABLED == STD_OFF ) && ((DET_DEBUG_ENABLED == STD_OFF) || \
  ...
  DET_DUMMY_STATEMENT(ModuleId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  DET_DUMMY_STATEMENT(InstanceId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  DET_DUMMY_STATEMENT(ApiId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
  DET_DUMMY_STATEMENT(ErrorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
#  endif
# endif
 ...
 *
 **********************************************************************************************************************/
FUNC(Std_ReturnType, DET_CODE) Det_ReportRuntimeError( uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId ) /* PRQA S 1503 */ /* MD_MSR_14.1 */ /*lint -e{438} */
{
 ...
 *
 **********************************************************************************************************************/
FUNC(Std_ReturnType, DET_CODE) Det_ReportTransientFault( uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId ) /* PRQA S 1503 */ /* MD_MSR_14.1 */ /*lint -e{438} */
{
