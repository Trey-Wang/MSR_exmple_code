...
# 2014/11/28   2.00.00  Ath  ESCAN00079883: Removed ExtSync.c and RelTimer.c  #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.2                                                       #
###############################################################################
...
FrIf_FILES               = FrIf\FrIf.c FrIf\FrIf_AbsTimer.c FrIf\FrIf_Rx.c \
FrIf\FrIf_Time.c FrIf\FrIf_Trcv.c FrIf\FrIf_Tx.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += FrIf\FrIf.c
CC_FILES_TO_BUILD       += FrIf\FrIf_AbsTimer.c
CC_FILES_TO_BUILD       += FrIf\FrIf_Rx.c
CC_FILES_TO_BUILD       += FrIf\FrIf_Time.c
CC_FILES_TO_BUILD       += FrIf\FrIf_Trcv.c
CC_FILES_TO_BUILD       += FrIf\FrIf_Tx.c
