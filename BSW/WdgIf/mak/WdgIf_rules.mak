...
# ----------   -------  ---- -------------------------------------------------#
# 2016/02/18   1.00.00  Chl  Initial Version of migrated WdgIf_rules.mak      #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
# REGISTRY 
# 
#e.g.: LIBRARIES_TO_BUILD      +=    WdgIf
#e.g.: WdgIf_FILES = WdgIf\WdgIf.c
LIBRARIES_TO_BUILD      += WdgIf
WdgIf_FILES = WdgIf\WdgIf.c
# e.g.: CC_FILES_TO_BUILD       += WdgIf\WdgIf.c WdgIf\WdgIf_Irq.c
CC_FILES_TO_BUILD       += WdgIf\WdgIf.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\WdgIf_Lcfg.c
