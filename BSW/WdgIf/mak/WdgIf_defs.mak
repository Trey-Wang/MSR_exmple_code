...
# ----------   -------  ---- -------------------------------------------------#
# 2016/03/08   1.00.00  Chl  Initial Version of migrated WdgIf_defs.mak       #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
WDGIF_CORE_PATH       = $(SSC_ROOT)\WdgIf


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


WDGIF_OUTPUT_PATH     = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += $(WDGIF_CORE_PATH)  $(WDGIF_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
