...
#                            MICROSAR 3 J1939Tp_cfg.mak version 1.04          #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
##############################################################
# J1939TP_CONFIG_PATH: (not used for Vector)
# The Variable J1939TP_CONFIG_PATH is optional. It allows the
...
# targets, then different J1939Tp configurations of different
# directories will be necessary. Therefor the variable
# J1939TP_CONFIG_PATH should be used.
#
# For example:
# J1939TP_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
# J1939TP_CONFIG_PATH = $(PROJECT_ROOT)\source\network\st10
# J1939TP_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
#
##############################################################
