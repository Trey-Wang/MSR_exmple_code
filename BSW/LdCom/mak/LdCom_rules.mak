...
# --------     ---------------------     -------------------------------------#
# visswa       Sebastian Waldvogel       Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Author  Change Id      Description                    #
# ----------   -------  ------  -------------  -------------------------------#
# 2014-05-13   1.00.00  visswa  ESCAN00074218  AR4-665: Efficient COM         #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
LdCom_FILES             = LdCom\LdCom.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += LdCom\LdCom.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\LdCom_PBcfg.c $(GENDATA_DIR)\LdCom_Lcfg.c
