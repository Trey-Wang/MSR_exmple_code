###############################################################################
# File Name  : Tp_Iso10681_check.mak                                          #
...
#e.g.: PREPARE_CONFIGURATION_INTERFACE     += TP_ISO10681_MODULES 
...
# SPECIFIC
#
#ifneq ($(FR_DRIVER_MODE),singlechannel)
#ifneq ($(FR_DRIVER_MODE),multichannel)
#$(error The value of the variable FR_DRIVER_MODE is not valid. \
