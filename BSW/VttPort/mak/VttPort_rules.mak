...
LIBRARIES_TO_BUILD      += Port
Port_FILES               = VttPort\Port.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttPort\Port.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Port_PBcfg.c
