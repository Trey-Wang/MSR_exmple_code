...
# ----------   -------  ---- -------------------------------------------------#
# 2017/08/28   1.00.00  chl  Initial Version of migrated vCanCcCdm_rules.mak  #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += vCanCcCdm
vCanCcCdm_FILES          = vCanCcCdm\vCanCcCdm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += vCanCcCdm\vCanCcCdm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\vCanCcCdm_Cfg.c
