...
# ----------   -------  ---- -------------------------------------------------#
# 2017/08/28   1.00.00  chl  Initial Version of migrated vCanCcCdm_defs.mak   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
VCANCCCDM_CORE_PATH       =   $(SSC_ROOT)\vCanCcCdm


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


VCANCCCDM_OUTPUT_PATH     =  $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(VCANCCCDM_CORE_PATH)  $(VCANCCCDM_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
