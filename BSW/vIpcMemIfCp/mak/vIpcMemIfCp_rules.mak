###############################################################################
# File Name  : vIpcMemIfCp_rules.mak                                          #
...
CC_FILES_TO_BUILD       += vIpcMemIfCp\vIpcMemIfCp.c
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\vIpcMemIfCp_Cfg.c       \
                           $(GENDATA_DIR)\vIpcMemIfCp_PBcfg.c
