...
##############################################################
# VCANCCGBT_CONFIG_PATH: (not used for Vector)
# The Variable VCANCCGBT_CONFIG_PATH is optional. It allows the
...
# targets, then different vCanCcGbt configurations of different
# directories will be necessary. Therefor the variable
# VCANCCGBT_CONFIG_PATH should be used.
#
# For example:
# VCANCCGBT_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
# VCANCCGBT_CONFIG_PATH = $(PROJECT_ROOT)\source\network\st10
# VCANCCGBT_CONFIG_PATH = $(PROJECT_ROOT)\source\network\v850
#
##############################################################
