...
LIBRARIES_TO_BUILD      += vCanCcGbt
vCanCcGbt_FILES          = vCanCcGbt\vCanCcGbt.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += vCanCcGbt\vCanCcGbt.c 
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\vCanCcGbt_Cfg.c $(GENDATA_DIR)\vCanCcGbt_Lcfg.c $(GENDATA_DIR)\vCanCcGbt_PBcfg.c
