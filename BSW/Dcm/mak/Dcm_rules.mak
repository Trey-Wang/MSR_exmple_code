...
# ----------   -------  ---- -------------------------------------------------#
# 2012/06/29   1.00     sa   initial CFG5 version derived from                #
#                            Gw_AsrPduR_Cfg5                                  #
# 2014/11/20   3.00     sa   Added Dcm_PBCfg.c                                #
# 2015/02/12   4.00     sa   New file infrastructure structure                #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
Dcm_FILES               = Dcm\Dcm.c
Dcm_FILES               += Dcm\Dcm_Ext.c

# e.g.: CC_FILES_TO_BUILD       += <MSN>\<MSN>.c <MSN>\<MSN>_Irq.c
CC_FILES_TO_BUILD       += Dcm\Dcm.c
CC_FILES_TO_BUILD       += Dcm\Dcm_Ext.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
