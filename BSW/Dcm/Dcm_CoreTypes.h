...
# define DCM_CORETYPES_MAJOR_VERSION                                 8u
# define DCM_CORETYPES_MINOR_VERSION                                 3u
# define DCM_CORETYPES_PATCH_VERSION                                 1u
/* ----------------------------------------------
 ~&&&   Switches
---------------------------------------------- */
...
# if (DCM_VARMGR_MULTI_SVC_EXCLUSIVE_ENABLED  == STD_ON) || \
     (DCM_VARMGR_MULTI_SVC_INCLUSIVE_ENABLED  == STD_ON)                                                                                             /* COV_DCM_SUPPORT_PARTIALLY TF tf xf */
