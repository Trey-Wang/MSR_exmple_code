...
# tne          Thomas Necker             Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
...
#                            Gw_AsrPduR_Cfg5                                  #
# 2012/07/19            get  Lower case module abbreviation                   #
# 2012/07/23            ade  Adapt to AR4                                     #
# 2012/11/05            tne  corrected comments                               #
# 2014/02/21   2.00.00  tne  added FiM_PBcfg.c                                #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\FiM_Lcfg.c $(GENDATA_DIR)\FiM_PBcfg.c
