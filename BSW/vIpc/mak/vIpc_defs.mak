...
#-----------------------------------------------------------------------------# 
# Refer to the vIpc_rules.mak file.                                            # 
############################################################################### 
############################################################### 
...
VIPC_CORE_PATH       =  ${SSC_ROOT}\vIpc
# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR) 
VIPC_OUTPUT_PATH     =  ${GENDATA_DIR}
...
#------------------------------------------------------------------------------------------ 
CC_INCLUDE_PATH     += ${VIPC_CORE_PATH} ${GENDATA_DIR}
CPP_INCLUDE_PATH    += 
ASM_INCLUDE_PATH    += 
