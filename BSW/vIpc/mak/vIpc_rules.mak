...
#e.g.: Msn_FILES = Msn\Msn.c 
LIBRARIES_TO_BUILD      += vIpc
vIpc_FILES               = vIpc\vIpc.c vIpc\vIpc_PQ.c vIpc\vIpc_Rx.c vIpc\vIpc_Tx.c
# e.g.: CC_FILES_TO_BUILD       += Msn\Msn.c Msn\Msn_Irq.c 
CC_FILES_TO_BUILD       += vIpc\vIpc.c vIpc\vIpc_PQ.c vIpc\vIpc_Rx.c vIpc\vIpc_Tx.c
CPP_FILES_TO_BUILD      += 
ASM_FILES_TO_BUILD      += 
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\vIpc_Lcfg.c $(GENDATA_DIR)\vIpc_PBcfg.c
