...
LIBRARIES_TO_BUILD      += Adc
Adc_FILES                = VttAdc\Adc.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttAdc\Adc.c VttAdc\Adc_Irq.c VttCntrl\VttCntrl_Adc.c 
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Adc_PBcfg.c $(GENDATA_DIR)\VttCntrl_Adc_Cfg.c
