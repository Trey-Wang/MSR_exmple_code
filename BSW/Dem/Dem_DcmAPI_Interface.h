 ...
 */
/*! \ingroup    Dem_Master
 *  \defgroup   Dem_DcmAPI Diagnostic Communication Manager interface
 *  \{
 *  \file       Dem_DcmAPI_Interface.h
...
#if !defined (DEM_DCMAPI_INTERFACE_H)
#define DEM_DCMAPI_INTERFACE_H
 ...
 *                The requested data was not copied
 *
 * \config        DEM_CFG_SUPPORT_OBDII == STD_ON && DEM_CFG_SUPPORT_DCM == STD_ON
 * \pre           -
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Get the DTC holding the OBD Freeze Frame (Mode02)
 *
 * \details       Returns the DTC holding the OBD Freeze Frame.
 *
...
#if (DEM_CFG_SUPPORT_OBDII == STD_ON) && (DEM_CFG_SUPPORT_VID08 == STD_ON)                                                       /* COV_MSR_UNSUPPORTED XF xf xf */
/* ****************************************************************************
 ...
 * \param[in]     OpStatus
 *                not evaluated
 * \param[in]     Iumprdata08
 *                not evaluated
 *
 * \return        E_NOT_OK
 *
 * \config           DEM_CFG_SUPPORT_OBDII == STD_ON
 *                && DEM_CFG_SUPPORT_VID08 == STD_ON
 *                && DEM_CFG_SUPPORT_DCM == STD_ON
 * \pre           -
 *
 * \context       TASK|ISR2
...
Dem_DcmGetInfoTypeValue08(
  ...
  Dem_DcmDataPtrType  Iumprdata08
  );
#endif

#if (DEM_CFG_SUPPORT_OBDII == STD_ON) && (DEM_CFG_SUPPORT_VID0B == STD_ON)                                                       /* COV_MSR_UNSUPPORTED XF xf xf */
/* ****************************************************************************
 ...
 * \param[in]     OpStatus
 *                not evaluated
 * \param[in]     Iumprdata0B
 *                not evaluated
 *
 * \return        E_NOT_OK
 *
 * \config           DEM_CFG_SUPPORT_OBDII == STD_ON
 *                && DEM_CFG_SUPPORT_VID0B == STD_ON
 *                && DEM_CFG_SUPPORT_DCM == STD_ON
 * \pre           -
 *
 * \context       TASK|ISR2
...
Dem_DcmGetInfoTypeValue0B(
  Dcm_OpStatusType  OpStatus,
  Dem_DcmDataPtrType  Iumprdata0B
  );
#endif
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID01(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID01value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID1C == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID1C(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID1Cvalue                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID21 == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID21(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID21value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID30 == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID30(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID30value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID31 == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID31(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID31value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID41 == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID41(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID41value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID4D == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 * Dem_DcmReadDataOfPID4D
 *****************************************************************************/
/*!
 * \brief         Returns the time run by the engine while MIL is active.
 *
 * \details       The value is latched at 0xFFFF
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID4D(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID4Dvalue                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if ((DEM_CFG_SUPPORT_OBDII == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)) && (DEM_CFG_SUPPORT_PID4E == STD_ON)               /* COV_MSR_UNSUPPORTED XF xf xf xf */
/* ****************************************************************************
 * Dem_DcmReadDataOfPID4E
 *****************************************************************************/
/*!
 * \brief         Returns the time run by the engine since DTCs cleared.
 *
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID4E(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID4Evalue                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif

#if (DEM_CFG_SUPPORT_WWHOBD == STD_ON) && (DEM_CFG_SUPPORT_PID91 == STD_ON)                                                      /* COV_MSR_UNSUPPORTED XF xf xf */
/* ****************************************************************************
 ...
 *****************************************************************************/
FUNC(Std_ReturnType, DEM_CODE)
Dem_DcmReadDataOfPID91(                                                                                                          /* PRQA S 3451 */ /* MD_DEM_8.8_dcm */
  P2VAR(uint8, AUTOMATIC, DEM_DCM_DATA)  PID91value                                                                              /* PRQA S 1330 */ /* MD_DEM_16.4_dcm */
  );
#endif
...
#endif /* DEM_DCMAPI_INTERFACE_H */

/*!
 * \}
 */
/* ********************************************************************************************************************
 *  END OF FILE: Dem_DcmAPI_Interface.h
 *********************************************************************************************************************/
