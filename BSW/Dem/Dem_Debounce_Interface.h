 ...
 *  \defgroup   Dem_Debounce Debounce
 *  \{
 *  \}
 *
 *  \ingroup    Dem_Debounce
 *  \defgroup   Dem_Debounce_Interface Debounce Interface (Facade)
 *  \{
 *  \file       Dem_Debounce_Interface.h
 *  \brief      Implementation file for the MICROSAR Dem
 *  \details    Public interface of Debounce subcomponent
 *********************************************************************************************************************/
 ...
 *****************************************************************************/
/*!
 * \brief         Process the similar conditions for an event.
 *
 * \details       Process the similar conditions for an event.
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Preinitialize the debouncing of a monitor.
 *
 * \details       Preinitialize the debouncing of a monitor.
 *
