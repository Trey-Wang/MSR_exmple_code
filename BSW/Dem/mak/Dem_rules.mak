...
# 2012/07/23            mhe  Removed unneeded Dem_PBcfg.c                     #
...
LIBRARIES_TO_BUILD      += Dem
Dem_FILES                = Dem\Dem.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Dem\Dem.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Dem_Lcfg.c $(GENDATA_DIR)\Dem_PBcfg.c
