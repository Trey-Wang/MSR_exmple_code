 ...
 *               && (DEM_CFG_STORAGE_AT_CONFIRMED == STD_OFF) )
 *             || (DEM_CFG_AGING_START_TRIGGER_PASSED == STD_OFF)
 *
 *
 * \context       TASK|ISR2
 ...
 *****************************************************************************/
/*!
 * \brief         Get the NV Block handle of the first secondary memory block
 *
 * \details       Get the NV Block handle of the first secondary memory block
 *
 * \return        The NV Block handle of the first secondary memory block
 *
 * \pre           -
 * \config        DEM_CFG_USE_NVM == STD_ON &&
