...
#               C O P Y R I G H T                                             #
#-----------------------------------------------------------------------------#
# Copyright (c) 2011; 2014 by Vector Informatik GmbH.  All rights reserved.   #
#                                                                             #
#-----------------------------------------------------------------------------#
...
# ----------   -------  ------ -----------------------------------------------#
# 2011/03/14   1.00.00  vismdr Initial Version based on template 1.0          #
# 2014/12/12   2.00.00  vismdr Removed NmOsek_Lcfg.c                          #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 2.00.00                                                   #
###############################################################################
...
CC_FILES_TO_BUILD       += NmOsek\NmOsek.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\NmOsek_cfg.c $(GENDATA_DIR)\NmOsek_PBcfg.c 
