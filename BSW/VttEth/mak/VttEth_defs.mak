...
#-----------------------------------------------------------------------------#
# Refer to the makefile VttEth_rules.mak                                       #
#                                                                             #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
###############################################################################
...
ETH_CORE_PATH       = $(SSC_ROOT)\VttEth
# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
ETH_OUTPUT_PATH     = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += $(ETH_CORE_PATH) $(ETH_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
