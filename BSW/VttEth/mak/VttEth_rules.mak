...
# ----------   ------- ------  -----------------------------------------------#
# 2013/02/24   1.00.00 vishaw  Initial creation                               #
# 2015/03/05   2.00.00 vismha  Renaming VIP to VTT                            #
# 2017/02/09   3.00.00 vismha  Introduced API infixing                        #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 3.0                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += VttEth
VttEth_FILES             = VttEth\Eth_30_Vtt*.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       +=
else
CC_FILES_TO_BUILD       += VttEth\Eth_30_Vtt*.c VttCntrl\VttCntrl_Eth.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Eth_30_Vtt_*.c $(GENDATA_DIR)\VttCntrl_Eth_Cfg.c
