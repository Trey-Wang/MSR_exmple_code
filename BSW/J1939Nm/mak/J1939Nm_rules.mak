...
#               C O P Y R I G H T                                             #
#-----------------------------------------------------------------------------#
# Copyright (c) 2015 Vector Informatik GmbH.  All rights reserved.            #
#                                                                             #
#-----------------------------------------------------------------------------#
...
# ----------   -------  ---- -------------------------------------------------#
# 2015-01-16   1.00     Msr  Initial Version of Template for fully dynamic NM #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.0                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += J1939Nm
J1939Nm_FILES            = J1939Nm\J1939Nm.c
J1939Nm_FILES           += J1939Nm\J1939Nm_Dynamic.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += J1939Nm\J1939Nm.c 
CC_FILES_TO_BUILD       += J1939Nm\J1939Nm_Dynamic.c 
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\J1939Nm_Cfg.c $(GENDATA_DIR)\J1939Nm_Lcfg.c $(GENDATA_DIR)\J1939Nm_PBcfg.c
