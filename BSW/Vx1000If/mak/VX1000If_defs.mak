...
#
# VX1000IF_MODULES       (required)  (not necessary for Vector)
# VX1000IF_DRIVER_MODE   (required)  (not necessary for Vector)
# VX1000IF_PROJECT_PATH  (optional)
# VX1000IF_BUILD_LIBRARY (required)
...
# e.g.: $(VX1000IF_CORE_PATH) = $(SSC_ROOT)\VX1000If  could be used for CPP_INCLUDE_PATH    +=  $(VX1000IF_CORE_PATH)\CPP_FILES\...
VX1000IF_CORE_PATH       = $(SSC_ROOT)\VX1000If
# e.g.: VX1000IF_OUTPUT_PATH = $(GENDATA_DIR)
VX1000IF_OUTPUT_PATH     = $(GENDATA_DIR)

#VX1000IF_TOOL_PATH      = $(PROJECT_ROOT)\core\com\can\gentool

# it is also possible to generate own configurations with some checks like the following example
#  ifneq ( $(VX1000IF_CONFIG_PATH),)
#      VX1000IF_PROJECT_PATH    = $(VX1000IF_CONFIG_PATH)
#  else
#     VX1000IF_PROJECT_PATH    = $(PROJECT_ROOT)\source\network\can
#  endif 
...
# e.g.: CC_INCLUDE_PATH     += $(VX1000IF_CORE_PATH)
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += $(VX1000IF_CORE_PATH) $(VX1000IF_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=

#PREPROCESSOR_DEFINES+= drivermode

#drivermode_KEY       = VX1000IF_MODE
#drivermode_VALUE    = $(VX1000IF_DRIVER_MODE)
