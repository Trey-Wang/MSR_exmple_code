...
#e.g.: PREPARE_CONFIGURATION_INTERFACE     += VX1000IF_MODULES 
...
# SPECIFIC
#
#ifneq ($(VX1000IF_DRIVER_MODE),singlechannel)
#ifneq ($(VX1000IF_DRIVER_MODE),multichannel)
#$(error The value of the variable VX1000IF_DRIVER_MODE is not valid. \
