...
# ----------   -------  ---- -------------------------------------------------#
# 2016/02/18   1.00.00  Chl  Initial Version of migrated WdgM_defs.mak        #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
WDGM_CORE_PATH       =   $(SSC_ROOT)\WdgM


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


WDGM_OUTPUT_PATH     =  $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(WDGM_CORE_PATH)  $(WDGM_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
