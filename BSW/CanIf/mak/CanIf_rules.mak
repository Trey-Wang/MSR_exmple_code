...
# 2007/08/04   1.01     Ard  Adapted to AUTOSAR CanIf                         #
# 2008/04/30   1.02     fbg  Changes for ASR library support                  #
# 2016/07/12   1.03     Rna  CanIf_DataChecksum conditionally added           #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += CanIf
CanIf_FILES             = CanIf\CanIf.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += $(CanIf_FILES)
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanIf_PBcfg.c $(GENDATA_DIR)\CanIf_Lcfg.c
