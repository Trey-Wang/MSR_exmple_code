...
# ----------   -------  ------ -----------------------------------------------#
# 2010/04/28   1.00.00  visal  Created                                        #
# 2010/07/20   1.00.01  visal  Time and certificate handling added            #
# 2011/03/08   1.02.00  visal  all Tls_Cert... files removed                  #
# 2011/12/16   2.00.00  visal  remove Tls_Time.c                              #
# 2016/03/02   3.00.00  visal  remove Tls_PBcfg.c                             #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Tls_Lcfg.c
