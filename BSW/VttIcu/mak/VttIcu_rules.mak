...
LIBRARIES_TO_BUILD      += Icu
Icu_FILES                = VttIcu\Icu.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += VttIcu\Icu.c VttIcu\Icu_Irq.c VttCntrl\VttCntrl_Icu.c 
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Icu_PBcfg.c $(GENDATA_DIR)\VttCntrl_Icu_Cfg.c
