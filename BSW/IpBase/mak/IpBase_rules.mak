...
# ----------   -------  ------ -----------------------------------------------#
# 2010/10/01   1.00.00  visalr Created                                        #
# 2011/12/02   1.00.01  visalr IpBase_Sock added                              #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
IpBase_FILES             = IpBase\IpBase.c IpBase\IpBase_Code.c IpBase\IpBase_Copy.c IpBase\IpBase_Sock.c IpBase\IpBase_String.c IpBase\IpBase_PBuf.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += IpBase\IpBase.c IpBase\IpBase_Code.c IpBase\IpBase_Copy.c IpBase\IpBase_Sock.c IpBase\IpBase_String.c IpBase\IpBase_PBuf.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
