...
#if (  (ECUM_SW_MAJOR_VERSION != (0x08u)) \
    || (ECUM_SW_MINOR_VERSION != (0x00u)) \
    || (ECUM_SW_PATCH_VERSION != (0x02u)) )
...
/* vendor specific version information is BCD coded */
#if (  (ECUM_CBK_SW_MAJOR_VERSION != (0x08u)) \
    || (ECUM_CBK_SW_MINOR_VERSION != (0x00u)) \
    || (ECUM_CBK_SW_PATCH_VERSION != (0x02u)) )
...
# if (ECUM_CORE_ID_BSW >= EcuM_GetSizeOfCoreStatus())
#  error "Id of the BSW Core does not fit to the range of Core Ids."
# endif
 ...
 **********************************************************************************************************************/
#define EcuM_EnterCriticalArea_0()        SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_0()   /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */
#define EcuM_LeaveCriticalArea_0()        SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_0()    /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */

#if(ECUM_NUMBER_OF_CORES > 1)
# define EcuM_EnterCriticalArea_1()        SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_1()   /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */
# define EcuM_LeaveCriticalArea_1()        SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_1()    /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */
#endif
...
#  define EcuM_EnterCriticalArea_2()       SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_2()   /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */
#  define EcuM_LeaveCriticalArea_2()       SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_2()    /* PRQA S 3453, 3109 */ /* MD_EcuM_3453, MD_MSR_14.3  */
# else
...
#if(ECUM_ATOMIC_VARIABLE_ACCESS < 32U)
# define EcuM_EnterAtomicAccess_0()       EcuM_EnterCriticalArea_0()                /* PRQA S 3453 */ /* MD_EcuM_3453 */
# define EcuM_LeaveAtomicAccess_0()       EcuM_LeaveCriticalArea_0()                /* PRQA S 3453 */ /* MD_EcuM_3453 */
#else
...
#if((ECUM_NUMBER_OF_CORES > 1) && (ECUM_CORERESOURCE == STD_ON))
...
#define ECUM_DRIVERINITLIST_ONE                               EcuM_GetFunctionOfDriverInitOne(0)
#define ECUM_DRIVERRESTART_LIST                               EcuM_GetFunctionOfDriverRestartList(0)

#if(ECUM_FIXED_BEHAVIOR == STD_ON)
# define ECUM_DRIVERINITLIST_TWO                              EcuM_GetFunctionOfDriverInitTwo(0)
# define ECUM_DRIVERINITLIST_THREE                            EcuM_GetFunctionOfDriverInitThree(0)
#endif

#if (((ECUM_FIXED_BEHAVIOR == STD_ON) && (ECUM_SUPPORT_RTE_MODE_SWITCH == STD_ON)) || ECUM_MODE_HANDLING == STD_ON)
# define ECUM_RTE_SWITCH(MODE)                                (void)Rte_Switch_currentMode_currentMode((MODE)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#else
...
#if((ECUM_CHANNELOFWAKEUPSOURCELIST == STD_ON) ||(ECUM_PNCOFCOMMPNCS == STD_ON))
...
P2CONST(EcuM_PbConfigType, ECUM_VAR_NOINIT, ECUM_PBCFG) EcuM_ConfigDataPtr;
# endif
...
# if ((ECUM_NUMBER_OF_CORES > 1) && (ECUM_SLAVE_CORE_HANDLING == STD_ON))
  uint8_least loopCount;
  boolean EcuMWaitForSlaves;
# endif

# if (ECUM_POLLINGOFSLEEPMODELIST == STD_OFF)
  ECUM_DUMMY_STATEMENT(SuspendMode); /* PRQA S 3112 */ /* MD_EcuM_3112 */
# endif
  /* ----- Implementation ----------------------------------------------- */
...
# if (ECUM_ALARM_CLOCK_PRESENT == STD_ON)
    EcuM_GptSetSleep(EcuM_GetGptChannel(), GPT_MODE_SLEEP);
# endif
...
# endif
     ...
     *  are also in sleep. */
# if ((ECUM_NUMBER_OF_CORES > 1) && (ECUM_SLAVE_CORE_HANDLING == STD_ON))
    EcuM_SetCoreStatus(ECUM_CORE_ID_BSW, ECUM_CORESTATUS_SLEEP); /* SBSW_SETCORESTATUS_BSWCOREID */
    do
    {
      ...
      {
        if (EcuM_GetCoreStatus(loopCount) != ECUM_CORESTATUS_SLEEP)
        {
...
# if (ECUM_ALARM_CLOCK_PRESENT == STD_ON)
    ...
    EcuM_GptSetNormal(EcuM_GetGptChannel(), GPT_MODE_NORMAL);
...
# if ((ECUM_NUMBER_OF_CORES > 1) && (ECUM_SLAVE_CORE_HANDLING == STD_ON))
    ...
    EcuM_SetCoreStatus(ECUM_CORE_ID_BSW, ECUM_CORESTATUS_RUN); /* SBSW_SETCORESTATUS_BSWCOREID */
...
#  endif
  ...
  EcuM_SetCoreStatus(CoreID, ECUM_CORESTATUS_SLEEP); /* SBSW_SETCORESTATUS_OSCOREID */
  ...
  do
  {
    ...
    if (EcuM_GetCoreStatus(ECUM_CORE_ID_BSW) == ECUM_CORESTATUS_RUN)
    {
      WaitOnMaster = FALSE;
    }
    EcuM_LeaveCriticalArea_1();
  ...
  EcuM_SetCoreStatus(CoreID, ECUM_CORESTATUS_RUN); /* SBSW_SETCORESTATUS_OSCOREID */
...
ECUM_LOCAL_INLINE FUNC(void, ECUM_CODE) EcuM_InternalComMNotifications(void)
{
  ...
  if (ComMStatus == COMM_INIT)
  {
    ...
    while ((EcuM_ComM_BufferedWakeups != 0u) && (sourceID > 0u)) /* COV_ECUM_01 */
    {
      ...
      if (((EcuM_WakeupSourceType) (1 << sourceID) & EcuM_ComM_BufferedWakeups) != 0u) /* COV_ECUM_04 */
      {
...
# endif
        ...
        EcuM_ComM_BufferedWakeups &= (EcuM_WakeupSourceType) (~(EcuM_WakeupSourceType) (1 << sourceID));
      }
    }
  }
}
...
ECUM_LOCAL_INLINE FUNC(void, ECUM_CODE) EcuM_InternalEnterPollingMode(void)
{
  ...
  while (ECUM_COMBINEDWAKEUPS == ECUM_WKSOURCE_NONE)
  {
    ...
    for (loopCount = 0u; loopCount < EcuM_GetSizeOfWakeupSourceList(); loopCount++)
    {
      ...
      if (((EcuM_WakeupSourceType) (1 << loopCount) &
           (EcuM_GetWakeupSourceOfSleepModeList(EcuM_CurrentShutdownMode))) != 0u)
      {
        ...
        {
          EcuM_CheckWakeup((EcuM_WakeupSourceType) (1 << loopCount));
        }
      }
    }
  }
...
# else
  ECUM_DUMMY_STATEMENT(ecumErrorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
# endif
...
# else
  ECUM_DUMMY_STATEMENT(errorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
# endif
...
#  if (ECUM_POLLINGOFSLEEPMODELIST == STD_ON)
    if(EcuM_IsPollingOfSleepModeList(EcuM_CurrentShutdownMode) == TRUE)
    {
...
ECUM_LOCAL FUNC(Std_ReturnType, ECUM_CODE) EcuM_InternalRequestRUN(uint8 ApiId, EcuM_UserType User, uint8 mask)
{
  ...
  uint8 errorId = ECUM_E_INVALID_PAR;
...
#  endif
    ...
    else
    {
      ...
      {
#  if(ECUM_MODE_HANDLING == STD_ON)
        if(EcuM_GetRunRequestCounter() == 0)
        {
...
#  endif
      ...
      {
#  if(ECUM_MODE_HANDLING == STD_ON)
        if(EcuM_GetPostRunRequestCounter() == 0)
        {
...
# endif
  {
    ...
    switch (state)
    {
      ...
      ECUM_DUMMY_STATEMENT(mode); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /*lint -e{438} */
    }
    if (errorId == ECUM_E_NO_ERROR)
    {
      /* ----- Implementation ----------------------------------------------- */
...
# endif /* (ECUM_FIXED_BEHAVIOR != STD_ON) */
    ...
    {
# if(ECUM_SLEEPMODELIST == STD_ON)
      /* #60 Shut down the slave core if the state equals GO_SLEEP. */
...
#  endif
      ...
      {
#  if(ECUM_FIXED_BEHAVIOR == STD_OFF)
        (void) EcuM_GoToSelectedShutdownTarget(); /* PRQA S 3112 */ /* MD_EcuM_3112 */
#  else
...
#  endif
      ...
      {
        /* No other action necessary on a slave core */
      }
# endif
    }
#endif
...
# if((ECUM_NUMBER_OF_CORES == 1) || (ECUM_CORE_ID_BSW == ECUM_CORE_ID_STARTUP))
      EcuM_InternalDeterminePbConfiguration();
# endif
      ...
      /* #50 Map the Mcu reset reason from the last occurred shutdown. */
      {
        ...
        for (loopCount = 0u; loopCount < EcuM_GetSizeOfWakeupSourceList(); loopCount++)
        {
          ...
          if ((EcuM_GetReasonOfWakeupSourceList(loopCount)) == resetReason)
          {
            ...
            EcuM_ValidatedWakeups |= ((EcuM_WakeupSourceType) (1u << loopCount));

            /* Store this source in the BufferedWakeups to validate it at the end of EcuM_StartupTwo */
            EcuM_BswM_BufferedWakeups |= ((EcuM_WakeupSourceType) (1u << loopCount));
            break;
          }
...
# if((ECUM_CONFIGURATION_VARIANT == ECUM_CONFIGURATION_VARIANT_POSTBUILD_LOADABLE) || (ECUM_POSTBUILD_VARIANT_SUPPORT == STD_ON))
#  if(ECUM_CORE_ID_BSW != ECUM_CORE_ID_STARTUP)
...
VAR(uint8, AUTOMATIC) resetSleepMode)
{
  /* ----- Local Variables ---------------------------------------------- */
  uint8 errorId = ECUM_E_NO_ERROR;
  Std_ReturnType retval;
...
# if(ECUM_VALIDOFSLEEPMODELIST == STD_ON)
      ...
      (EcuM_IsValidOfSleepModeList(resetSleepMode) == FALSE)
# endif
#endif
  )
  {
...
P2VAR(uint8, AUTOMATIC, ECUM_APPL_DATA) resetSleepMode)
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retval = E_NOT_OK;
  uint8 errorId = ECUM_E_NO_ERROR;
...
#else
  ECUM_DUMMY_STATEMENT(shutdownCause); /* PRQA S 3112 */ /* MD_EcuM_3112 */
#endif
  }
...
# if(ECUM_VALIDOFWAKEUPSOURCELIST == STD_ON)
      || (EcuM_IsValidOfWakeupSourceList(ShiftCount) == FALSE)
# endif
  )
  {
...
#  endif
  {
    ...
    ECUM_DUMMY_STATEMENT(JobResult); /* PRQA S 3112 */ /* MD_EcuM_3112 */
    ...
    P2VAR(EcuM_StateType, AUTOMATIC, ECUM_APPL_DATA) state)
{
  ...
  /* dummy assignment to prevent compiler warnings on most of the compilers. */
  ECUM_DUMMY_STATEMENT(user); /* PRQA S 3112 */ /* MD_EcuM_3112 */
...
#if(ECUM_ALARM_CLOCK_PRESENT == STD_ON)
      EcuM_GptStartClock(EcuM_GetGptChannel(), GPT_MODE_NORMAL, EcuM_GetGptValue());
#endif
...
# if(((ECUM_CHANNELOFWAKEUPSOURCELIST == STD_ON) && (ECUM_PNCOFCOMMPNCS == STD_ON)))
      if ((EcuM_GetChannelOfWakeupSourceList(Shiftcount) != 0xFFu)
          || (EcuM_GetComMPNCsStartIdxOfWakeupSourceList(Shiftcount) != ECUM_NO_COMMPNCSSTARTIDXOFWAKEUPSOURCELIST))
# elif (ECUM_CHANNELOFWAKEUPSOURCELIST == STD_ON)
      if (EcuM_GetChannelOfWakeupSourceList(Shiftcount) != 0xFFu)
# else
...
# endif
  ...
  /* ----- Development Error Checks ------------------------------------- */
# if(ECUM_NUMBER_OF_CORES > 1)
  /* #20 Check if the returned coreId is a valid one. */
#  if (ECUM_DEV_ERROR_DETECT == STD_ON)
  if (coreID >= EcuM_GetSizeOfCoreStatus())
  {
    EcuM_ErrorHook(ECUM_E_HOOK_INVALID_COREID);
...
# if (ECUM_GODOWNALLOWEDOFFLEXUSER == STD_ON)
    VAR(uint8_least, AUTOMATIC) LoopCount = 0u;
# else
    /* dummy assignment to prevent compiler warnings on most of the compilers. */
    ECUM_DUMMY_STATEMENT(caller); /* PRQA S 3112 */ /* MD_EcuM_3112 */
# endif
#endif
...
# if (ECUM_GODOWNALLOWEDOFFLEXUSER == STD_ON)
      ...
      for(LoopCount = 0; LoopCount < EcuM_GetSizeOfFlexUser(); LoopCount++)
      {
...
#  if(ECUM_ISDEF_GODOWNALLOWEDOFFLEXUSER == STD_OFF)
            && (EcuM_IsGoDownAllowedOfFlexUser(LoopCount) == TRUE)
#  endif
        )
        {
          retVal = E_OK;
...
#  if defined(ECUM_E_IMPROPER_CALLER)
...
# endif /* ECUM_GODOWNALLOWEDOFFLEXUSER == STD_ON) */
...
#endif /* (ECUM_FIXED_BEHAVIOR != STD_ON */
      {
        ...
        /* #32 Only if the CurrentShutdownTarget is OFF, the EcuM checks again for pending wakeups. */
        if (EcuM_CurrentShutdownTarget == ECUM_STATE_OFF)
        {
          ...
          if (ECUM_COMBINEDWAKEUPS != ECUM_WKSOURCE_NONE)
          {
            /* #33 In case of a detected pending wakeup, set the ShutdownTarget to reset and change the mode to ECUM_RESET_WAKEUP. */
        ...
        /* #34 Shut down the ASR OS, the routine expects an ErrorCode (E_OK) as parameter. */
  ...
  {
    /* #40 Deinitialize the SchM on the slave core. */
    SchM_Deinit();
  }
#endif
...
FUNC(Std_ReturnType, ECUM_CODE) EcuM_SetAbsWakeupAlarm(VAR(EcuM_UserType, AUTOMATIC) user,
    VAR(uint32, AUTOMATIC) time) /* PRQA S 5115 */ /* MD_EcuM_5115 */
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retval = E_NOT_OK;
  uint8 errorId = ECUM_E_NO_ERROR;
  ...
  else
  {
    ...
    if ((EcuM_GetAlarmClockTimeOut(AlarmClockUser) <= time)
    ...
    else
    {
      ...
      EcuM_SetAlarmClockTimeOut(AlarmClockUser, time); /* SBSW_ECUM_ACCESSALARMCLOCK */
    ...
    VAR(uint32, AUTOMATIC) time) /* PRQA S 5115 */ /* MD_EcuM_5115 */
{
  ...
  return EcuM_SetAbsWakeupAlarm(user, time + EcuM_Clock);
}
 ...
 *
 */
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetCurrentTime(P2VAR(uint32, AUTOMATIC, ECUM_APPL_DATA) time) /* PRQA S 5115 */ /* MD_EcuM_5115 */
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retval = E_NOT_OK;
  ...
  if(time != NULL_PTR)
  {
    ...
    *time = EcuM_Clock; /* SBSW_ECUM_POINTERACCESS_TIME */
 ...
 *
 */
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GetWakeupTime(P2VAR(uint32, AUTOMATIC, ECUM_APPL_DATA) time) /* PRQA S 5115 */ /* MD_EcuM_5115 */
{
  /* ----- Local Variables ---------------------------------------------- */
  Std_ReturnType retval = E_NOT_OK;
  ...
  if(time != NULL_PTR)
  {
    ...
    *time = EcuM_MasterAlarm; /* SBSW_ECUM_POINTERACCESS_TIME */
    EcuM_LeaveCriticalArea_2();
...
*
     ...
     MD_EcuM_3112:
     Reason:     Some compilers complain about unused parameters. Dummy statement is inserted for preventing those compilers from throwing warnings.
     Risk:       Statement exists although parameter is in use.
     Prevention: Covered by code review.
     ...
     MD_EcuM_5115:
     Reason:     AUTOSAR requires the parameter to be called 'time'.
     Risk:       No risk, as the time function of the standard library is not used in the function.
     Prevention: Covered by code review.
