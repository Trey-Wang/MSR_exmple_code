...
# define SYSSERVICE_ASR4ECUM_VERSION                                  0x0800u
# define SYSSERVICE_ASR4ECUM_RELEASE_VERSION                          0x02u
...
#else
# define ECUM_E_HOOK_INVALID_COREID                                   (Std_ReturnType)(0x09u)
#endif
 ...
 *  \trace       CREQ-438
 **********************************************************************************************************************/
FUNC(EcuM_ShutdownCauseType, ECUM_CODE) EcuM_GetShutdownCause(P2VAR(EcuM_ShutdownCauseType, AUTOMATIC, ECUM_APPL_DATA) shutdownCause);
 ...
 * \protects CoreStatus
 * \usedin EcuM_EnterSleep, EcuM_EnterSleepOnSlave
 * \exclude EcuM_GoHalt, EcuM_GoPoll, EcuM_GoToSelectedShutdownTarget (On a slave core).
 * \length SHORT
 * \endexclusivearea
 *
