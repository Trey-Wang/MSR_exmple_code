...
# --------     ---------------------     -------------------------------------#
# Vjn          Jochen Vorreiter          Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2012/07/13   1.00     Vjn  Initial Version of Template (1.0)                #
# 2013/04/12   1.01     Vjn  Added EcuM_Init_PBcfg.c + EcuM_Cfg.c             #
# 2013/04/12   2.00     Vjn  Removed EcuM_Callout_Stubs.c                     #
# 2015/01/20   2.01     Vjn  Added EcuM_Init_Cfg.c                              #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += EcuM
EcuM_FILES              = EcuM\EcuM.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c

CC_FILES_TO_BUILD       += EcuM\EcuM.c
...
GENERATED_SOURCE_FILES  +=  $(GENDATA_DIR)\EcuM_PBcfg.c $(GENDATA_DIR)\EcuM_Init_PBcfg.c $(GENDATA_DIR)\EcuM_Init_Cfg.c $(GENDATA_DIR)\EcuM_Cfg.c
