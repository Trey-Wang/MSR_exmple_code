...
# 2007/08/13   1.01     Chm  IoHwAb specific settings added                   #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
IOHWAB_CORE_PATH       =   $(SSC_ROOT)\IoHwAb


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


IOHWAB_OUTPUT_PATH     =  $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     +=  $(IOHWAB_CORE_PATH)  $(IOHWAB_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
