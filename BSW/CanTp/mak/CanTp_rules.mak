...
# ----------   -------  ---- -------------------------------------------------#
# 2012/07/13   1.00.00  Dth  Initial Version of Template (1.0)                #
# 2014/09/01   2.00.00  Dth  CanTp_Cfg.c removed from file list               #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
CanTp_FILES             = CanTp\CanTp.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CanTp\CanTp.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanTp_PBcfg.c $(GENDATA_DIR)\CanTp_Lcfg.c
