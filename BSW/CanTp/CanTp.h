 ...
 *                        visath  FEATC-667:     FEAT-2144: Mixed11 Addressing Priorization
...
# define CANTP_SW_MINOR_VERSION                  (3u)
 ...
 *  \param[in]     CanTpTxInfoPtr         Pointer to PduInfo struct with the length of the message to be transmitted.
 ...
 *  \synchronous   Configurable (FALSE by default)
 *  \pre           -
 *  \note          The PduInfo struct also contains a data pointer; this is not used by the CanTp and can be set to NULL.
 *  \trace         CREQ-102804
 **********************************************************************************************************************/
