...
#    $(error The value of the variable CAN_DRIVER_MODE is not valid. Please use singlechannel or multichannel)
#  endif
#endif
...
# REQUIRED
#
# No other resources are required for a Configuration Check Makefile.
###############################################################################
...
# PROVIDE
#
# A configuration Makefile does not provide resources for other basic software bundles or the base-make package.
###############################################################################
