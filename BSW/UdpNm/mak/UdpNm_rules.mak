...
# 2012/02/21   1.00.03  viswmc  Bugfix SoAd_FILES --> UdpNm_FILES             #
# 2012/04/03   1.01.00  viswmc  Added file UdpNm_Cfg.c (Cfg5)                 #
# 2013/05/07   1.02.00  vismha  Removed file UdpNm_Cfg.c                      #
# 2013/08/08   1.02.00  vismha  Removed file UdpNm_PBcfg.c                    #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES += $(GENDATA_DIR)\UdpNm_Lcfg.c
...
# all in err\ & obj\ & lst\ & lib\ & log\ will be deleted by clean-rule automaticly so in this clean-rule it is only
# necessary to define additional files which were not delete automaticly.
# e.g.: $(<PATH>)\can_test.c
#----------------------------------------------------------------------------------------------------------------------
MAKE_CLEAN_RULES       +=
#MAKE_GENERATE_RULES    +=
...
# SPECIFIC
#
# There are no rules defined for the Specific part of the Rules-Makefile. Each author is free to create temporary
